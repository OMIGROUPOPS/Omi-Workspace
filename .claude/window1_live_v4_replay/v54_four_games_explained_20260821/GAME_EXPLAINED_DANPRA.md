...
NEIGHBOR-GRAIN [NG-DANPRA]: receipt-bearing comparisons below are either RANGE_SPECTRUM_PATH polling paths (R-CORPUS + R-RANGE, approximately 100 ticks per leg) or HISTORICAL_EVENT_AGGREGATE rows (R-CORPUS + R-HIST, no intramatch path). RESOURCE-GAP [GAP-NG-DANPRA]: no raw-tape order-book depth receipt exists at the matched-neighbor stage; range-path best-five summaries are not raw depth.
...
BLEND-PROVENANCE [CP-7406fe8bc89a7b1a]: m = mean(score_i × coverage_i) across the seven named neighbors; full-precision machine value 0.838919100981, displayed-row check 5.872434/7 ≈ 0.838919142857. Inputs: R-STORY#line-528; R-CORPUS#rows-8368,8160,7564,8155,8150,7507,7765; R-RANGE#rows-3945,3744,3499,3739,3735,3452,3682. Lineage target and action operands: R-STORY#line-528.
