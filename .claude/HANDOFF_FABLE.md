...
**SESSION-ZERO READ: `truth/INDEX.json` FIRST** — laws (264) · surfaces (7) · sites (6) · studies (48). SECOND READ: truth/OPEN_LEDGER.md (every open thread; gate-checked every C50). Everything below is a pointer INTO the index's members:
...
## STATE (2026-07-16 DAYSHEET-LIVE — C50 keeps this current):
