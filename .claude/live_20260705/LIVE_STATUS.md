...
- cycle 15 @ **2026-07-11 02:32:27 PM ET** | build `c23098f8` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 49744 session events | monitor READ-ONLY
...
- **half_arm_aging**: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 812, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 810, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 787, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 765, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 762, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 744, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 705, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 669, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 659, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 656, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 649, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 639, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 629, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 627, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 625, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 600, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 596, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 586, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- **half_arm_aging**: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 582, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 572, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 565, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- **half_arm_aging**: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 540, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 538, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 528, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- **half_arm_aging**: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 514, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 514, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 509, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- **half_arm_aging**: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 502, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 483, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 472, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 438, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 429, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 388, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 387, "mode": "QUEUE(flow at/below our level, unfilled)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 380, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 372, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 371, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 371, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 370, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 369, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 340, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 332, "mode": "NO_BID(sib rested earlier, none now)"}
...
- classes now: {'FLOW_AT_LEVEL': 1, 'FLOW_ABOVE': 2} | repriceable now: true 0 / false 3 | **cumulative bid_grade lines: 8154 (repriceable true 1156 / false 6998)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA-F | 67 | 162m | 17/69-71/643 | 70-71 | 2 | **FLOW_ABOVE** | 66 | flow above but bound 66c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 387m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ITFWMATCH-26JUL11SHCCHA-SHC | 78 | 31m | 15/81-82/1402 | 80-82 | 3 | **FLOW_ABOVE** | 78 | flow above but bound 78c < flow -- chasing breaks goal |
...
| ITFMATCH-26JUL11MIYLEG | 41 | 28 | **69** | 97 | -28 |
...
| ATPCHALLENGERMATCH-26JUL11WALMIC | 33 | 62 | **95** | 97 | -2 |
...
## FLOW-STATE — 87 tracked game(s) ({'QUIET': 54, 'OPEN': 3, 'WAKING': 30}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA | ATP_CHALL | 0.633 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL11MEJVAR | ATP_CHALL | 2.033 | 1 | **OPEN** |
| ITFWMATCH-26JUL11SHCCHA | ITF_W | 0.767 | 2 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL11WALMIC | ATP_CHALL | 21.033 | — | **WAKING** |
| ATPMATCH-26JUL11BRAGOM | ATP_MAIN | 54.533 | — | **WAKING** |
...
| ATPMATCH-26JUL11NEUPOL | ATP_MAIN | 47.633 | — | **WAKING** |
| ATPMATCH-26JUL11PRAMAJ | ATP_MAIN | 15.367 | — | **WAKING** |
| ATPMATCH-26JUL11SKACHA | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11BAXLOK | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11BECANG | ITF_M | 25.967 | — | **WAKING** |
| ITFMATCH-26JUL11BERBEN | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11CIGZAR | ITF_M | 7.767 | — | **WAKING** |
| ITFMATCH-26JUL11ERECRA | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11FRAMAR | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11JOHKLA | ITF_M | 24.067 | — | **WAKING** |
| ITFMATCH-26JUL11MIYLEG | ITF_M | 44.367 | — | **WAKING** |
| ITFMATCH-26JUL11SAMLOP | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11SYDGON | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11YOUKIM | ITF_M | 111.333 | — | **WAKING** |
...
| ITFWMATCH-26JUL11MIRMAL | ITF_W | 17.933 | — | **WAKING** |
| WTAMATCH-26JUL11MICNIN | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11MORSZI | WTA_MAIN | 12.433 | — | **WAKING** |
| WTAMATCH-26JUL11PANKUL | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11TANNEP | WTA_MAIN | 106.2 | — | **WAKING** |
...
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 340, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 332, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 326, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 265, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 243, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 243, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 217, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 201, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 198, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 193, "mode": "NO_BID(sib rested earlier, none now)"}
...
- deep_neg_fv: KXITFMATCH-26JUL11MIYLEG-MIY {"entry_minus_fv_burst": -21.0, "emitted_et": "2026-07-11 02:32:27 PM ET"}
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 187, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 185, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 174, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 163, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 162, "mode": "SET_BELOW_FLOW(prints 2c above)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 157, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 147, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 128, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 89, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 85, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHCCHA-CHA {"fill": 19, "age_min": 31, "mode": "SET_BELOW_FLOW(prints 3c above)", "emitted_et": "2026-07-11 02:32:27 PM ET"}
