...
- cycle 25 @ **2026-07-10 09:10:35 PM ET** | build `96e06f6f` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 9273 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 122m | 170/27-30/15518 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 3.833 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 190, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 123, "mode": "SET_BELOW_FLOW(prints 3c above)"}
