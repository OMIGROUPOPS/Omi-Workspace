...
export function ExecutionStatsPanel({ specs }: Props) {
  ...
  return (
    <div className="rounded-lg border border-gray-800 bg-[#111] p-3">
      ...
      {/* Latency */}
      <div className="mb-4">
        <p className="text-[10px] text-white uppercase mb-2">Latency</p>
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded bg-gray-800/50 p-2">
            <span className="text-[10px] text-white block">Last Trade</span>
            {lastTrade.total_ms ? (
              <>
                ...
                <span className="text-[10px] text-white block">{lastTrade.team}</span>
              </>
            ) : <span className="text-sm text-white">-</span>}
          </div>
          <div className="rounded bg-gray-800/50 p-2">
            <span className="text-[10px] text-white block">Avg (Last 10)</span>
          ...
          <div className="rounded bg-gray-800/50 p-2">
            <span className="text-[10px] text-white block">All Time</span>
            {allTime.fastest_ms ? (
              <>
      ...
      {/* Tier breakdown */}
      <div>
        <p className="text-[10px] text-white uppercase mb-2">Tier Breakdown</p>
