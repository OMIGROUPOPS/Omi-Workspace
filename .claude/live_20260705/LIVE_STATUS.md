...
- cycle 15 @ **2026-07-10 07:28:19 PM ET** | build `c03d52a7` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 3191 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 20m | 12/28-30/1124 | 28-28 | 4 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS | ITF_M | 2.5 | — | **WAKING** |
| ITFMATCH-26JUL10POLMIY | ITF_M | 130.4 | — | **WAKING** |

## PATTERNS (sub-B) — 1
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 87, "mode": "PAIRING(sib never rested)"}
