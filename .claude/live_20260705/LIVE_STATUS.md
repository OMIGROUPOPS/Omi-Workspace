...
- cycle 350 @ **2026-07-18 02:27:16 PM ET** | build `ff0f5c5f` | session boot 07-18 13:59 ET | log `live_v3_20260718.jsonl` | 1301 session events | monitor READ-ONLY
...
- classes now: {'FLOW_ABOVE': 9, 'NO_FLOW': 1, 'FLOW_AT_LEVEL': 1} | repriceable now: true 6 / false 5 | **cumulative bid_grade lines: 12881 (repriceable true 1738 / false 11143)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL18LAJYUN-L | 33 | 21m | 1/37-37/2 | 36-37 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→37 |
| ATPCHALLENGERMATCH-26JUL18LAJYUN-Y | 63 | 26m | 4/64-64/450 | 63-64 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→64 |
| ATPCHALLENGERMATCH-26JUL18RODSAN-R | 72 | 9m | 7/79-80/237 | 79-80 | 7 | **FLOW_ABOVE** | 76 | flow above but bound 76c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL18TOMJOH-J | 55 | 27m | 6/58-59/501 | 57-59 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→58 |
| ATPCHALLENGERMATCH-26JUL18TOMJOH-T | 39 | 27m | 6/43-43/129 | 42-43 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→43 |
| ITFMATCH-26JUL18BASTAI-BAS | 73 | 27m | 1/87-87/22 | 86-87 | 14 | **FLOW_ABOVE** | 99 |  |
| ITFMATCH-26JUL18BASTAI-TAI | 13 | 17m | 10/14-14/227 | 13-14 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→14 |
| ITFWMATCH-26JUL18SAIHOS-HOS | 36 | 27m | 1/37-37/25 | 36-37 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→37 |
| ITFWMATCH-26JUL18SAIHOS-SAI | 63 | 26m | 7/63-65/167 | 64-65 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| ITFWMATCH-26JUL18THOAIA-AIA | 84 | 7m | 3/88-89/26 | 88-89 | 4 | **FLOW_ABOVE** | 84 | flow above but bound 84c < flow -- chasing breaks goal |
| WTACHALLENGERMATCH-26JUL18TONSPI-T | 31 | 27m | 0 | 31-59 | — | **NO_FLOW** | 99 |  |
...
## FLOW-STATE — 7 tracked game(s) ({'WAKING': 1, 'OPEN': 5, 'QUIET': 1}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL18RODSAN | ATP_CHALL | 0.633 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL18TOMJOH | ATP_CHALL | 0.4 | 1 | **OPEN** |
| ITFMATCH-26JUL18BASTAI | ITF_M | 0.367 | 1 | **OPEN** |
| ITFWMATCH-26JUL18SAIHOS | ITF_W | 0.267 | 1 | **OPEN** |
| ITFWMATCH-26JUL18THOAIA | ITF_W | 0.367 | 1 | **OPEN** |
| WTACHALLENGERMATCH-26JUL18TONSPI | WTA_CHALL | 0.0 | 28 | **QUIET** |
| ATPCHALLENGERMATCH-26JUL18LAJYUN | ATP_CHALL | 0.2 | 1 | **WAKING** |
