...
- cycle 20 @ **2026-07-10 08:19:24 PM ET** | build `8f4790a0` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 6942 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 71m | 86/27-30/9103 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 4.567 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 138, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 71, "mode": "SET_BELOW_FLOW(prints 3c above)"}
