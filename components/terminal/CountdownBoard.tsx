...
// Renders INSIDE a TermBox wrapper from parent Terminal.tsx (no header).
...
export default function CountdownBoard({
  ...
  return (
    ...
    >
      {/* Scrollable list — no header, parent box provides title */}
      <div
        style={{
          flex: 1,
          overflowY: "auto",
      ...
      >
        {hasCountdown ? (
          sorted.map((item) => {
            ...
            const label = parseTickerLabel(
              item.ticker,
              cdTeam || item.info.team,
              eventTicker
            );

            const timePct = Math.max(
              0,
              Math.min(100, (item.secs_to_close / 300) * 100)
            );
            ...
            return (
              <button
                ...
                style={{
                  ...
                  animation: urgent
                    ? "terminal-urgent-pulse 2s ease-in-out infinite"
                    : "none",
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = urgent
                    ? "rgba(255,51,102,0.04)"
                    : "transparent";
                }}
              >
                {/* Row 1: Label + price + time */}
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        color:
                          item.side === "near_100" ? "#00FF88" : "#FF3366",
                        fontSize: "8px",
                        flexShrink: 0,
                      }}
                    >
                ...
                {/* Row 3: Progress bar (time remaining) */}
                <div
                  style={{
                    height: "2px",
                    background: "#151515",
          ...
          upcomingMarkets.map((m) => {
            ...
            const proxPct = Math.max(
              0,
              100 - (distFromBoundary / 50) * 100
            );
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      style={{ color: dirColor, fontSize: "8px", flexShrink: 0 }}
                    >
                      {dirArrow}
                    </span>
                    <span
