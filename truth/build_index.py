...
**SESSION-ZERO READ: `truth/INDEX.json` FIRST** — laws (%d) · surfaces (%d) · sites (%d) · studies (%d). SECOND READ: truth/OPEN_LEDGER.md (every open thread; gate-checked every C50). Everything below is a pointer INTO the index's members:
