...
- cycle 10 @ **2026-07-11 01:38:16 PM ET** | build `8a68aab5` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 46492 session events | monitor READ-ONLY

## MORNING REVIEW — overnight watch fires (12:00 AM–9:00 AM ET) — 91 item(s)
...
- **half_arm_aging**: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 757, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 756, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 733, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 711, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 708, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 689, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 651, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 614, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 605, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 602, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 595, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 585, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 575, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 573, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 571, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 545, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 541, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 532, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- **half_arm_aging**: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 527, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 518, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 510, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- **half_arm_aging**: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 486, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 484, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 474, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- **half_arm_aging**: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 460, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 459, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 455, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- **half_arm_aging**: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 448, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 428, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 418, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 384, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 374, "mode": "NO_BID(sib rested earlier, none now)"}
- **pre_conception_buy**: KXITFWMATCH-26JUL11GORKOS-KOS {"price": 73, "conception_ts": 1783791033.819245, "detail": "buy 73c predates the conception stamp by 361min \u2014 honest-window buy, cap not yet defined (ungradeable)", "emitted_et": "2026-07-11 01:38:16 PM ET"}
- **half_arm_aging**: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 333, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 333, "mode": "QUEUE(flow at/below our level, unfilled)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 326, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 318, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 317, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 317, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 316, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 314, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 286, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 278, "mode": "NO_BID(sib rested earlier, none now)"}
...
| 11:50 | ATPCHALLENGERMATCH-26JUL11GALFEA-G | ATP_CHALL | underdog | 30 | 27 | +3 (place_cell) | — | pre | single |  | MIXED |
...
- classes now: {'FLOW_AT_LEVEL': 1, 'FLOW_ABOVE': 6, 'NO_FLOW': 1} | repriceable now: true 4 / false 4 | **cumulative bid_grade lines: 8150 (repriceable true 1155 / false 6995)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA-F | 67 | 107m | 4/69-71/70 | 69-71 | 2 | **FLOW_ABOVE** | 66 | flow above but bound 66c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 333m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL11WALMIC-M | 64 | 108m | 23/68-68/841 | 67-68 | 4 | **FLOW_ABOVE** | 64 | flow above but bound 64c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11BECANG-BEC | 69 | 0m | 0 | 69-70 | — | **NO_FLOW** | 91 |  |
| ITFMATCH-26JUL11VANZAM-VAN | 59 | 15m | 1/61-61/0 | 59-61 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→61 |
| ITFMATCH-26JUL11VANZAM-ZAM | 40 | 151m | 5/41-41/228 | 40-41 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→41 |
| ITFWMATCH-26JUL11SHCCHA-CHA | 19 | 187m | 17/20-21/1862 | 19-21 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→20 |
| ITFWMATCH-26JUL11SHCCHA-SHC | 80 | 134m | 6/82-82/81 | 80-82 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→82 |
...
## FLOW-STATE — 88 tracked game(s) ({'QUIET': 47, 'WAKING': 32, 'OPEN': 9}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11WALMIC | ATP_CHALL | 0.6 | 1 | **OPEN** |
| ATPMATCH-26JUL11PRAMAJ | ATP_MAIN | 6.233 | 1 | **OPEN** |
| ITFMATCH-26JUL11BAXLOK | ITF_M | 16.0 | 1 | **OPEN** |
| ITFMATCH-26JUL11BECANG | ITF_M | 0.9 | 1 | **OPEN** |
| ITFMATCH-26JUL11SYDGON | ITF_M | 0.767 | 1 | **OPEN** |
| ITFMATCH-26JUL11VANZAM | ITF_M | 0.333 | 1 | **OPEN** |
| ITFWMATCH-26JUL11MIRMAL | ITF_W | 16.033 | 1 | **OPEN** |
| ITFWMATCH-26JUL11SHCCHA | ITF_W | 0.633 | 2 | **OPEN** |
| WTAMATCH-26JUL11MORSZI | WTA_MAIN | 5.833 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL11DIAGAS | ATP_CHALL | 108.967 | 8 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GALFEA | ATP_CHALL | 0.167 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GIUDAM | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11MEJVAR | ATP_CHALL | 5.167 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11PIRKYM | ATP_CHALL | 13.2 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11SEABAS | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPMATCH-26JUL11BRAGOM | ATP_MAIN | 26.967 | — | **WAKING** |
...
| ATPMATCH-26JUL11NEUPOL | ATP_MAIN | 12.933 | — | **WAKING** |
| ATPMATCH-26JUL11SKACHA | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11BERBEN | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11CIGZAR | ITF_M | 30.533 | — | **WAKING** |
| ITFMATCH-26JUL11ERECRA | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11FRAMAR | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11JOHKLA | ITF_M | 16.6 | — | **WAKING** |
| ITFMATCH-26JUL11MIYLEG | ITF_M | 8.8 | — | **WAKING** |
| ITFMATCH-26JUL11SAMLOP | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11SVAZHU | ITF_M | 11.533 | — | **WAKING** |
| ITFMATCH-26JUL11WEIGHA | ITF_M | 38.2 | — | **WAKING** |
| ITFMATCH-26JUL11YOUKIM | ITF_M | 35.133 | — | **WAKING** |
| ITFWMATCH-26JUL11BABGER | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL11GORKOS | ITF_W | 8.933 | — | **WAKING** |
| ITFWMATCH-26JUL11HOSDAA | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL11MARPAR | ITF_W | 0.0 | 4 | **WAKING** |
| WTACHALLENGERMATCH-26JUL11MINVOL | WTA_CHALL | 11.6 | — | **WAKING** |
| WTAMATCH-26JUL11MICNIN | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11PANKUL | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11TANNEP | WTA_MAIN | 42.1 | — | **WAKING** |
| WTAMATCH-26JUL11YASGLU | WTA_MAIN | 36.733 | — | **WAKING** |
...
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 286, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 278, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 271, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 210, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 189, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 188, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 162, "mode": "NO_BID(sib rested earlier, none now)"}
- pre_conception_buy: KXITFWMATCH-26JUL11GORKOS-KOS {"price": 74, "conception_ts": 1783791033.819245, "detail": "buy 74c predates the conception stamp by 147min \u2014 honest-window buy, cap not yet defined (ungradeable)", "emitted_et": "2026-07-11 01:38:16 PM ET"}
- reality_divergence: KXITFMATCH-26JUL11KELWES-KEL {"kind": "position_basis", "ref": 63.0, "market_mid": 5.5, "divergence": 57.5}
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 146, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 144, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 139, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 133, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 130, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 120, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 108, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 108, "mode": "SET_BELOW_FLOW(prints 2c above)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 102, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 93, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 73, "mode": "NO_BID(sib rested earlier, none now)"}
- deep_neg_fv: KXATPMATCH-26JUL11NEUPOL-NEU {"entry_minus_fv_burst": -28.0, "emitted_et": "2026-07-11 01:38:16 PM ET"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 35, "mode": "NO_BID(sib rested earlier, none now)", "emitted_et": "2026-07-11 01:38:16 PM ET"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 30, "mode": "PAIRING(sib never rested)", "emitted_et": "2026-07-11 01:38:16 PM ET"}
