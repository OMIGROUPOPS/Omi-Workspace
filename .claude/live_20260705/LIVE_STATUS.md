...
- cycle 90 @ **2026-07-12 03:46:38 AM ET** | build `5ffc4bf7` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 144994 session events | monitor READ-ONLY

## MORNING REVIEW — overnight watch fires (12:00 AM–9:00 AM ET) — 7 item(s)
- **half_arm_aging**: KXITFMATCH-26JUL12MILARZ-ARZ {"fill": 27, "age_min": 151, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12ALVVAN-VAN {"fill": 22, "age_min": 147, "mode": "SET_BELOW_FLOW(prints 5c above)"}
- **half_arm_aging**: KXITFMATCH-26JUL12MONSHI-MON {"fill": 85, "age_min": 106, "mode": "SET_BELOW_FLOW(prints 2c above)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12DELMAK-DEL {"fill": 8, "age_min": 90, "mode": "STARVATION(no prints since post)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12GANJAN-GAN {"fill": 20, "age_min": 70, "mode": "SET_BELOW_FLOW(prints 3c above)"}
- **half_arm_aging**: KXWTAMATCH-26JUL12GARPRI-GAR {"fill": 39, "age_min": 45, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL12KULZAA-ZAA {"fill": 67, "age_min": 41, "mode": "NO_BID(sib rested earlier, none now)"}
...
| 02:36 | ATPCHALLENGERMATCH-26JUL12GANJAN-G | ATP_CHALL | ? | 20 | 15 | +5 (place_cell) | — | pre | single |  | MIXED |
...
- classes now: {'FLOW_AT_LEVEL': 4, 'FLOW_ABOVE': 32, 'NO_FLOW': 40} | repriceable now: true 21 / false 55 | **cumulative bid_grade lines: 8321 (repriceable true 1199 / false 7122)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 1181m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL12ALVVAN-A | 73 | 165m | 4/78-79/20 | 75-76 | 5 | **FLOW_ABOVE** | 75 | flow above but bound 75c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12BALPET-B | 12 | 141m | 0 | 12-15 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12BALPET-P | 85 | 144m | 5/85-88/59 | 85-87 | 0 | **FLOW_AT_LEVEL** | 84 |  |
| ATPCHALLENGERMATCH-26JUL12CHAJON-C | 41 | 45m | 1/43-43/42 | 41-43 | 2 | **FLOW_ABOVE** | 40 | flow above but bound 40c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12CHAJON-J | 56 | 45m | 0 | 56-57 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12CRIBAS-B | 64 | 136m | 3/64-66/10 | 64-65 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12CRIBAS-C | 35 | 81m | 0 | 35-36 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12DELMAK-M | 89 | 90m | 0 | 92-93 | — | **NO_FLOW** | 89 |  |
| ATPCHALLENGERMATCH-26JUL12FORPAM-F | 94 | 225m | 9/95-96/57 | 95-96 | 1 | **FLOW_ABOVE** | 91 | flow above but bound 91c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12GANJAN-J | 77 | 70m | 1/80-80/6 | 78-80 | 3 | **FLOW_ABOVE** | 77 | flow above but bound 77c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12GUTCAM-G | 30 | 75m | 0 | 30-33 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12KRALOR-K | 94 | 45m | 0 | 94-95 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12PIETAB-P | 65 | 45m | 0 | 65-66 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12PIETAB-T | 32 | 45m | 0 | 32-33 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12POLVIN-P | 38 | 45m | 0 | 40-42 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12POLVIN-V | 59 | 45m | 0 | 59-60 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12RAQKUM-K | 52 | 165m | 6/55-57/289 | 54-55 | 3 | **FLOW_ABOVE** | 52 | flow above but bound 52c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12RAQKUM-R | 43 | 132m | 0 | 43-45 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12VILRAH-R | 29 | 196m | 12/31-32/398 | 29-31 | 2 | **FLOW_ABOVE** | 28 | flow above but bound 28c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12VILRAH-V | 68 | 165m | 18/70-71/630 | 69-69 | 2 | **FLOW_ABOVE** | 67 | flow above but bound 67c < flow -- chasing breaks goal |
| ATPMATCH-26JUL12ALTGAS-ALT | 57 | 148m | 1/58-58/36 | 57-58 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→58 |
| ATPMATCH-26JUL12ALTGAS-GAS | 42 | 160m | 0 | 42-43 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12CORDAN-COR | 29 | 16m | 0 | 29-30 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12DEJGAU-GAU | 32 | 125m | 1/33-33/1 | 32-33 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→33 |
| ATPMATCH-26JUL12FARWAW-FAR | 63 | 262m | 8/64-67/1332 | 66-64 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→64 |
| ATPMATCH-26JUL12MOLFAU-FAU | 33 | 16m | 0 | 33-34 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12OFNTIR-OFN | 42 | 200m | 2/44-44/64 | 42-43 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→44 |
| ATPMATCH-26JUL12OFNTIR-TIR | 56 | 141m | 0 | 57-58 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12PASKAS-KAS | 48 | 30m | 1/50-50/1015 | 48-49 | 2 | **FLOW_ABOVE** | 50 | REPRICEABLE→50 |
| ATPMATCH-26JUL12SONSCH-SCH | 32 | 228m | 0 | 35-35 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12SVRDIM-SVR | 34 | 46m | 0 | 34-35 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12BORNOR-BOR | 65 | 44m | 0 | 66-66 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12BORNOR-NOR | 33 | 106m | 0 | 33-36 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12DONWIS-WIS | 49 | 45m | 1/51-51/94 | 49-51 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→51 |
| ITFMATCH-26JUL12DURDOU-DOU | 72 | 61m | 4/74-74/157 | 72-74 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→74 |
| ITFMATCH-26JUL12DURDOU-DUR | 26 | 192m | 1/29-29/49 | 26-29 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→29 |
| ITFMATCH-26JUL12LOPLAG-LAG | 36 | 200m | 3/38-38/43 | 36-38 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→38 |
| ITFMATCH-26JUL12LOPLAG-LOP | 62 | 75m | 19/63-65/593 | 63-63 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→63 |
| ITFMATCH-26JUL12MILARZ-MIL | 70 | 151m | 19/74-74/742 | 72-72 | 4 | **FLOW_ABOVE** | 70 | flow above but bound 70c < flow -- chasing breaks goal |
| ITFMATCH-26JUL12MONSHI-SHI | 12 | 106m | 20/14-18/501 | 14-15 | 2 | **FLOW_ABOVE** | 12 | flow above but bound 12c < flow -- chasing breaks goal |
| ITFMATCH-26JUL12PAPSNI-PAP | 27 | 45m | 0 | 27-31 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12PAPSNI-SNI | 70 | 18m | 0 | 70-72 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12WESJUA-JUA | 53 | 102m | 1/54-54/89 | 53-54 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→54 |
| ITFMATCH-26JUL12WESJUA-WES | 45 | 106m | 0 | 45-48 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12GUPFER-GUP | 12 | 0m | 0 | 16-40 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12LEEGAO-GAO | 45 | 106m | 0 | 45-50 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12LEYHOS-HOS | 46 | 196m | 2/50-50/38 | 46-49 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→50 |
| ITFWMATCH-26JUL12LEYHOS-LEY | 52 | 30m | 0 | 52-53 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12LIUPUS-PUS | 55 | 36m | 0 | 55-81 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12ROJPER-PER | 56 | 154m | 1/60-60/1 | 56-59 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→60 |
| ITFWMATCH-26JUL12ROJPER-ROJ | 41 | 154m | 2/44-44/119 | 41-44 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→44 |
| ITFWMATCH-26JUL12RYSHRU-HRU | 58 | 19m | 1/59-59/32 | 59-59 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→59 |
| ITFWMATCH-26JUL12RYSHRU-RYS | 40 | 59m | 2/44-44/1521 | 40-43 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→44 |
| ITFWMATCH-26JUL12SOBGOR-GOR | 29 | 45m | 0 | 29-34 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12SOBGOR-SOB | 66 | 45m | 0 | 66-70 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12TOMKAR-TOM | 43 | 23m | 24/47-49/1108 | 48-46 | 4 | **FLOW_ABOVE** | 43 | flow above but bound 43c < flow -- chasing breaks goal |
| ITFWMATCH-26JUL12VEDBOS-BOS | 34 | 16m | 0 | 34-38 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12VEDBOS-VED | 62 | 10m | 0 | 62-64 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ARIZHA-Z | 63 | 161m | 1/65-65/307 | 63-65 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→65 |
| WTACHALLENGERMATCH-26JUL12BOSKOV-B | 93 | 148m | 0 | 94-95 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12CIRHUA-C | 6 | 16m | 0 | 6-7 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12FEICHE-C | 24 | 75m | 0 | 24-25 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12FEICHE-F | 74 | 75m | 2/76-76/25 | 74-76 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→76 |
| WTACHALLENGERMATCH-26JUL12PALCOL-C | 21 | 45m | 0 | 21-24 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12PALCOL-P | 76 | 75m | 0 | 76-79 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12PANYOR-P | 83 | 16m | 0 | 83-84 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12SHITUR-S | 82 | 106m | 4/84-85/37 | 83-84 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→84 |
| WTACHALLENGERMATCH-26JUL12SHITUR-T | 16 | 90m | 0 | 16-18 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ZELFAL-F | 78 | 16m | 0 | 78-80 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ZELFAL-Z | 20 | 16m | 0 | 20-21 | — | **NO_FLOW** | 99 |  |
| WTAMATCH-26JUL12AVASEI-AVA | 88 | 106m | 1/89-89/2 | 88-89 | 1 | **FLOW_ABOVE** | 89 | REPRICEABLE→89 |
| WTAMATCH-26JUL12AVASEI-SEI | 11 | 106m | 4/11-11/281 | 11-12 | 0 | **FLOW_AT_LEVEL** | 9 |  |
| WTAMATCH-26JUL12HERKAZ-KAZ | 46 | 106m | 11/47-47/3360 | 46-47 | 1 | **FLOW_ABOVE** | 44 | flow above but bound 44c < flow -- chasing breaks goal |
| WTAMATCH-26JUL12LIUPOP-POP | 13 | 16m | 0 | 13-14 | — | **NO_FLOW** | 12 |  |
| WTAMATCH-26JUL12WERAMA-WER | 78 | 136m | 14/80-82/168 | 80-79 | 2 | **FLOW_ABOVE** | 81 | REPRICEABLE→80 |
...
| WTAMATCH-26JUL12GARPRI | 39 | 22 | **61** | 97 | -36 |
...
| ITFMATCH-26JUL12MILARZ | 27 | 72 | **99** | 97 | +2 |
| WTAMATCH-26JUL12KULZAA | 67 | 32 | **99** | 97 | +2 |
| ITFMATCH-26JUL12MONSHI | 85 | 15 | **100** | 97 | +3 |
| ATPCHALLENGERMATCH-26JUL12GANJAN | 20 | 80 | **100** | 97 | +3 |
| ITFWMATCH-26JUL12TOMKAR | 54 | 46 | **100** | 97 | +3 |
...
## FLOW-STATE — 142 tracked game(s) ({'QUIET': 73, 'WAKING': 66, 'OPEN': 3}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ITFMATCH-26JUL12MILARZ | ITF_M | 0.367 | 3 | **OPEN** |
| ITFMATCH-26JUL12MONSHI | ITF_M | 0.433 | 1 | **OPEN** |
| ITFWMATCH-26JUL12TOMKAR | ITF_W | 1.6 | 1 | **OPEN** |
...
| ITFWMATCH-26JUL12LIUPUS | ITF_W | 0.0 | 26 | **QUIET** |
...
| ATPCHALLENGERMATCH-26JUL12BALPET | ATP_CHALL | 0.1 | 2 | **WAKING** |
...
| ATPCHALLENGERMATCH-26JUL12FORPAM | ATP_CHALL | 0.033 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12GANJAN | ATP_CHALL | 0.033 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12GUTCAM | ATP_CHALL | 0.0 | 3 | **WAKING** |
...
| ATPCHALLENGERMATCH-26JUL12RAQKUM | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12VILRAH | ATP_CHALL | 0.233 | 2 | **WAKING** |
...
| ATPMATCH-26JUL12DEJGAU | ATP_MAIN | 0.0 | 1 | **WAKING** |
...
| ITFMATCH-26JUL12DURDOU | ITF_M | 0.033 | 2 | **WAKING** |
| ITFMATCH-26JUL12LOPLAG | ITF_M | 0.133 | 2 | **WAKING** |
...
| ITFWMATCH-26JUL12CORBRU | ITF_W | 40.2 | — | **WAKING** |
| ITFWMATCH-26JUL12GUPFER | ITF_W | 0.033 | 24 | **WAKING** |
| ITFWMATCH-26JUL12LEEGAO | ITF_W | 0.0 | 5 | **WAKING** |
| ITFWMATCH-26JUL12LEYHOS | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL12ROJPER | ITF_W | 0.0 | 3 | **WAKING** |
| ITFWMATCH-26JUL12RYSHRU | ITF_W | 0.1 | 3 | **WAKING** |
...
| WTACHALLENGERMATCH-26JUL12FEICHE | WTA_CHALL | 0.033 | 1 | **WAKING** |
...
| WTAMATCH-26JUL12GARPRI | WTA_MAIN | 20.633 | — | **WAKING** |
| WTAMATCH-26JUL12HERKAZ | WTA_MAIN | 0.133 | 1 | **WAKING** |
| WTAMATCH-26JUL12KULZAA | WTA_MAIN | 12.633 | — | **WAKING** |
| WTAMATCH-26JUL12LIUPOP | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL12WERAMA | WTA_MAIN | 0.133 | — | **WAKING** |
...
- half_arm_aging: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 1606, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 1605, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 1581, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 1559, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 1556, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 1538, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 1500, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 1463, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 1454, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 1451, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 1443, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 1433, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 1423, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 1421, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 1419, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 1394, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 1390, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 1380, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- half_arm_aging: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 1376, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 1366, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 1359, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- half_arm_aging: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 1335, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 1333, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 1322, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- half_arm_aging: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 1308, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 1308, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 1303, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- half_arm_aging: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 1296, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 1277, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 1266, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 1232, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 1223, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 1182, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 1181, "mode": "QUEUE(flow at/below our level, unfilled)"}
- half_arm_aging: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 1174, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 1166, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 1165, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 1165, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 1165, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 1163, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 1134, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 1126, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 1120, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 1059, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 1037, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 1037, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 1011, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 995, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 992, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 987, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 982, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 979, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 968, "mode": "NO_BID(sib rested earlier, none now)"}
- deep_neg_fv: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"entry_minus_fv_burst": -23.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 957, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 956, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 951, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 941, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 922, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 883, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 879, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHCCHA-CHA {"fill": 19, "age_min": 825, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL12MILARZ-ARZ {"fill": 27, "age_min": 151, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL12ALVVAN-VAN {"fill": 22, "age_min": 147, "mode": "SET_BELOW_FLOW(prints 5c above)"}
- half_arm_aging: KXITFMATCH-26JUL12MONSHI-MON {"fill": 85, "age_min": 106, "mode": "SET_BELOW_FLOW(prints 2c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL12DELMAK-DEL {"fill": 8, "age_min": 90, "mode": "STARVATION(no prints since post)"}
