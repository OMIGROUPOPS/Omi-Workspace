...
- cycle 23 @ **2026-07-10 08:50:01 PM ET** | build `b72668bc` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 8110 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 102m | 142/27-30/11907 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 4.133 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 169, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 102, "mode": "SET_BELOW_FLOW(prints 3c above)"}
