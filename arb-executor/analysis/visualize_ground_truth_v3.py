...
(function () {
  ...
  function selectRow(c) {
    ...
    renderTable(
      ...
      `Every conceivable R for this entry cent (pooled). Breakeven R≥${r ? r.breakevenFloorR : "—"}, ceiling R≤${r ? r.ceilingMaxR : "—"}. Complement ${r && r.complementC!=null ? r.complementC+"c" : "—"}. $ = pooled EV over all ${M.nTotal.toLocaleString()} N @10ct.` + achLine,
