...
- cycle 15 @ **2026-07-06 05:48:22 PM ET** | build `cdad901` | session boot 07-06 15:26 ET | log `live_v3_20260706.jsonl` | 12851 session events | monitor READ-ONLY
...
- classes now: {'FLOW_ABOVE': 2, 'NO_FLOW': 1} | repriceable now: true 0 / false 3 | **cumulative bid_grade lines: 2496 (repriceable true 234 / false 2262)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL06VUKBRO-B | 49 | 142m | 1/51-51/3 | 49-51 | 2 | **FLOW_ABOVE** | 48 | flow above but bound 48c < flow -- chasing breaks goal |
| ITFMATCH-26JUL06PHATOM-PHA | 15 | 29m | 3/24-25/58 | 15-24 | 9 | **FLOW_ABOVE** | 99 |  |
| ITFMATCH-26JUL06TAGSUZ-SUZ | 17 | 21m | 0 | 17-21 | — | **NO_FLOW** | 99 |  |
...
| ATPCHALLENGERMATCH-26JUL06ABOALVA | 55 | 30 | **85** | 97 | -12 |
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06SANARN-ARN {"fill": 53, "age_min": 142, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06KOZJOH-KOZ {"fill": 66, "age_min": 137, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL06GARPER-PER {"fill": 27, "age_min": 131, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06GLIYUN-GLI {"fill": 16, "age_min": 121, "mode": "PAIRING(sib never rested)"}
- deep_neg_fv: KXITFWMATCH-26JUL06JULOLI-JUL {"entry_minus_fv_burst": -31.5}
- half_arm_aging: KXITFWMATCH-26JUL06JULOLI-JUL {"fill": 16, "age_min": 117, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06GOMRIB-RIB {"fill": 80, "age_min": 113, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPMATCH-26JUL06LEHZVE-LEH {"fill": 24, "age_min": 105, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06ABOALVA-ABO {"fill": 55, "age_min": 38, "mode": "PAIRING(sib never rested)"}
