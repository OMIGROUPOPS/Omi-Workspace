...
- cycle 17 @ **2026-07-06 06:08:35 PM ET** | build `59ee566` | session boot 07-06 15:26 ET | log `live_v3_20260706.jsonl` | 18274 session events | monitor READ-ONLY
...
- classes now: {'FLOW_ABOVE': 3, 'NO_FLOW': 2} | repriceable now: true 2 / false 3 | **cumulative bid_grade lines: 2500 (repriceable true 235 / false 2265)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL06VUKBRO-B | 49 | 162m | 2/51-51/50 | 49-51 | 2 | **FLOW_ABOVE** | 48 | flow above but bound 48c < flow -- chasing breaks goal |
| ITFMATCH-26JUL06OCHMUT-OCH | 74 | 8m | 1/77-77/1 | 74-77 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→77 |
| ITFMATCH-26JUL06PHATOM-PHA | 16 | 0m | 0 | 16-24 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL06TAGSUZ-SUZ | 17 | 42m | 2/21-22/8 | 17-21 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→21 |
| ITFWMATCH-26JUL06GAONON-GAO | 16 | 9m | 0 | 16-29 | — | **NO_FLOW** | 99 |  |
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06SANARN-ARN {"fill": 53, "age_min": 162, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06KOZJOH-KOZ {"fill": 66, "age_min": 157, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL06GARPER-PER {"fill": 27, "age_min": 151, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06GLIYUN-GLI {"fill": 16, "age_min": 142, "mode": "PAIRING(sib never rested)"}
- deep_neg_fv: KXITFWMATCH-26JUL06JULOLI-JUL {"entry_minus_fv_burst": -31.5}
- half_arm_aging: KXITFWMATCH-26JUL06JULOLI-JUL {"fill": 16, "age_min": 137, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06GOMRIB-RIB {"fill": 80, "age_min": 133, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXATPMATCH-26JUL06LEHZVE-LEH {"fill": 24, "age_min": 125, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL06ABOALVA-ABO {"fill": 55, "age_min": 58, "mode": "PAIRING(sib never rested)"}
