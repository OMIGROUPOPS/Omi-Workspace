...
- cycle 29 @ **2026-07-10 09:51:21 PM ET** | build `5e1210ab` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 11372 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 163m | 327/27-30/27664 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 9.4 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 230, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 163, "mode": "SET_BELOW_FLOW(prints 3c above)"}
