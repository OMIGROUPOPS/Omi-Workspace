...
function main() {
  ...
  const receipt = {
    ...
    stacking: false,
    repair: variant === "FIX_A" ? "REARM_OBSERVED_LOW_WITHIN_ONE_CENT_ON_FRESH_OWN_BOOK_RECEIPT; PLACE_AT_CURRENT_LIVE_ASK" : "REASK_UNANIMOUS_LOWER_AFTER_LATER_QUALIFIED_OWN_ASK_SETTLEMENT_RECEIPT",
