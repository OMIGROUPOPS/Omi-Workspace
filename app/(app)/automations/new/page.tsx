    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="px-8 py-6">
          <h1 className="text-2xl font-semibold text-gray-900">Add New Automation</h1>
          <p className="text-sm text-gray-500 mt-1">Create a new automation workflow</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="e.g., Client Follow-up Reminder"
              />
            </div>
