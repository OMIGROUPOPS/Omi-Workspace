...
**STATE 2026-08-07 — V36 faller-side mirror anatomy frozen:** 511 sides V36 read FALLING at union reach conserve to 399 issues + 112 controls. Primary measured classes: state mislabeled 157/835¢, cap-bound 125/412¢, rest too shallow 54/273¢, rest walk lag 28/47¢; 35 strict-fill seams carry zero policy cents. Both-book candidate-signal lift is descriptive only. No policy or replay ran. See `.claude/window1_live_v4_replay/v36_faller_side_mirror_anatomy_20260807/` and `arb-executor/docs/research/window1/V36_FALLER_SIDE_MIRROR_ANATOMY_20260807_ADDENDUM.md`.
