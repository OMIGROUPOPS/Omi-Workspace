...
- cycle 215 @ **2026-07-17 02:47:49 PM ET** | build `b9f05cf6` | session boot 07-17 13:26 ET | log `live_v3_20260717.jsonl` | 5238 session events | monitor READ-ONLY
...
| 14:33:25 | **flatten_leash** | KXATPCHALLENGERMATCH-26JUL17RODCRA-ROD | flatten DEFERRED: ev -0.84 above margin floor -3.0 |
| 14:33:26 | **flatten_leash** | KXATPCHALLENGERMATCH-26JUL17SANALM-ALM | flatten DEFERRED: ev -2.37 above margin floor -3.0 |
| 14:44:28 | **flatten_leash** | KXATPCHALLENGERMATCH-26JUL17RODCRA-ROD | flatten DEFERRED: ev -0.84 above margin floor -3.0 |
| 14:44:28 | **flatten_leash** | KXATPCHALLENGERMATCH-26JUL17SANALM-ALM | flatten DEFERRED: ev -2.37 above margin floor -3.0 |
...
| 14:41 | ITFMATCH-26JUL17FRULEG-LEG | ITF_M | ? | 80 | 81 | -1 (place_cell) | — | pre | single |  | MIXED |

## RESTING BIDS — 5 tape-graded (starvation = NO_FLOW only)
- classes now: {'FLOW_ABOVE': 4, 'NO_FLOW': 1} | repriceable now: true 1 / false 4 | **cumulative bid_grade lines: 12547 (repriceable true 1651 / false 10896)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17HOLBOU-B | 33 | 80m | 1/34-34/407 | 33-34 | 1 | **FLOW_ABOVE** | 31 | flow above but bound 31c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL17HOLBOU-H | 66 | 48m | 6/67-67/436 | 66-67 | 1 | **FLOW_ABOVE** | 64 | flow above but bound 64c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL17VUKGAL-G | 48 | 46m | 3/52-53/332 | 51-53 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→52 |
| ATPCHALLENGERMATCH-26JUL17VUKGAL-V | 43 | 46m | 0 | 47-49 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL17FRULEG-FRU | 13 | 6m | 9/20-24/346 | 18-20 | 7 | **FLOW_ABOVE** | 15 | flow above but bound 15c < flow -- chasing breaks goal |

## COULD-HAVE-FILLED — open pairs, achievable-combined RIGHT NOW
| event | basis | sib ask | achievable | goal | vs goal |
|---|---|---|---|---|---|
| ITFMATCH-26JUL17FRULEG | 80 | 20 | **100** | 97 | +3 |
...
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17DRAGEA | ATP_CHALL | 15.833 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL17RODCRA | ATP_CHALL | 0.333 | 1 | **OPEN** |
| ATPMATCH-26JUL17DZUMOL | ATP_MAIN | 1.333 | 1 | **OPEN** |
| ITFMATCH-26JUL17FRULEG | ITF_M | 1.4 | 2 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL17HOLBOU | ATP_CHALL | 0.2 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL17SANALM | ATP_CHALL | 0.2 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL17VUKGAL | ATP_CHALL | 0.067 | 2 | **WAKING** |

## PATTERNS (sub-B) — 6
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17SEKCAS-SEK {"kind": "position_basis", "ref": 38.0, "market_mid": 2.5, "divergence": 35.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17SANALM-ALM {"fill": 48, "age_min": 49, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17DRAGEA-GEA {"fill": 65, "age_min": 47, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17RODCRA-ROD {"fill": 71, "age_min": 47, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17PERSAN-SAN {"kind": "position_basis", "ref": 54.0, "market_mid": 10.0, "divergence": 44.0}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17DELFUE-DEL {"kind": "position_basis", "ref": 86.0, "market_mid": 57.5, "divergence": 28.5}
