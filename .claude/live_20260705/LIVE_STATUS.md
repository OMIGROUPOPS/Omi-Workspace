...
- cycle 12 @ **2026-07-11 01:59:46 PM ET** | build `eb44f152` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 48000 session events | monitor READ-ONLY
...
- **half_arm_aging**: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 779, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 778, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 754, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 733, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 730, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 711, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 673, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 636, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 627, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 624, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 617, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 606, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 596, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 594, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 593, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 567, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 563, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 553, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- **half_arm_aging**: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 549, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 540, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 532, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- **half_arm_aging**: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 508, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 506, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 496, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- **half_arm_aging**: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 481, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 481, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 476, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- **half_arm_aging**: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 469, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 450, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 440, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 406, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 396, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 355, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 354, "mode": "QUEUE(flow at/below our level, unfilled)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 347, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 340, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 339, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 338, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 338, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 336, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 307, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 300, "mode": "NO_BID(sib rested earlier, none now)"}
...
- classes now: {'FLOW_AT_LEVEL': 1, 'FLOW_ABOVE': 6} | repriceable now: true 4 / false 3 | **cumulative bid_grade lines: 8153 (repriceable true 1156 / false 6997)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA-F | 67 | 129m | 5/69-71/93 | 69-71 | 2 | **FLOW_ABOVE** | 66 | flow above but bound 66c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 354m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL11WALMIC-M | 64 | 130m | 62/66-68/3695 | 66-67 | 2 | **FLOW_ABOVE** | 64 | flow above but bound 64c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11VANZAM-VAN | 60 | 16m | 3/61-61/88 | 60-61 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→61 |
| ITFMATCH-26JUL11VANZAM-ZAM | 40 | 173m | 9/41-41/394 | 40-41 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→41 |
| ITFWMATCH-26JUL11SHCCHA-CHA | 19 | 209m | 24/20-21/2028 | 19-20 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→20 |
| ITFWMATCH-26JUL11SHCCHA-SHC | 80 | 156m | 12/82-82/186 | 80-82 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→82 |
...
| ATPMATCH-26JUL11BRAGOM | 54 | 22 | **76** | 97 | -21 |
...
| ATPCHALLENGERMATCH-26JUL11WALMIC | 33 | 67 | **100** | 97 | +3 |
...
| ITFMATCH-26JUL11CIGZAR | 26 | 98 | **124** | 97 | +27 |
...
## FLOW-STATE — 88 tracked game(s) ({'QUIET': 49, 'WAKING': 30, 'OPEN': 9}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11WALMIC | ATP_CHALL | 2.1 | 1 | **OPEN** |
| ITFMATCH-26JUL11BAXLOK | ITF_M | 0.2 | 1 | **OPEN** |
| ITFMATCH-26JUL11BECANG | ITF_M | 11.1 | 1 | **OPEN** |
| ITFMATCH-26JUL11JOHKLA | ITF_M | 19.633 | 1 | **OPEN** |
| ITFMATCH-26JUL11VANZAM | ITF_M | 0.333 | 1 | **OPEN** |
| ITFWMATCH-26JUL11MIRMAL | ITF_W | 13.767 | 1 | **OPEN** |
| ITFWMATCH-26JUL11SHCCHA | ITF_W | 0.933 | 1 | **OPEN** |
| WTAMATCH-26JUL11MORSZI | WTA_MAIN | 7.533 | 1 | **OPEN** |
| WTAMATCH-26JUL11TANNEP | WTA_MAIN | 65.333 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL11DIAGAS | ATP_CHALL | 0.6 | 8 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GALFEA | ATP_CHALL | 0.1 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GIUDAM | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11MEJVAR | ATP_CHALL | 3.867 | 3 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11SEABAS | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPMATCH-26JUL11BRAGOM | ATP_MAIN | 31.033 | — | **WAKING** |
...
| ATPMATCH-26JUL11NEUPOL | ATP_MAIN | 26.033 | — | **WAKING** |
| ATPMATCH-26JUL11PRAMAJ | ATP_MAIN | 10.3 | — | **WAKING** |
| ATPMATCH-26JUL11SKACHA | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11BERBEN | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11CIGZAR | ITF_M | 34.267 | — | **WAKING** |
| ITFMATCH-26JUL11ERECRA | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11FRAMAR | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11MIYLEG | ITF_M | 19.0 | — | **WAKING** |
| ITFMATCH-26JUL11SAMLOP | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11SVAZHU | ITF_M | 6.633 | — | **WAKING** |
| ITFMATCH-26JUL11SYDGON | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11WEIGHA | ITF_M | 8.067 | — | **WAKING** |
| ITFMATCH-26JUL11YOUKIM | ITF_M | 55.967 | — | **WAKING** |
...
| WTACHALLENGERMATCH-26JUL11MINVOL | WTA_CHALL | 2.633 | — | **WAKING** |
| WTAMATCH-26JUL11MICNIN | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11PANKUL | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11YASGLU | WTA_MAIN | 88.867 | — | **WAKING** |
...
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 307, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 300, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 293, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 232, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 210, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 210, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 184, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 168, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 165, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 160, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 155, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 152, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 142, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 130, "mode": "SET_BELOW_FLOW(prints 2c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 129, "mode": "SET_BELOW_FLOW(prints 2c above)"}
...
- deep_neg_fv: KXWTAMATCH-26JUL11TANNEP-TAN {"entry_minus_fv_burst": -40.0, "emitted_et": "2026-07-11 01:59:46 PM ET"}
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 124, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 115, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 95, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 57, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 52, "mode": "PAIRING(sib never rested)"}
...
- deep_neg_fv: KXWTAMATCH-26JUL11MORSZI-MOR {"entry_minus_fv_burst": -11.5, "emitted_et": "2026-07-11 01:59:46 PM ET"}
