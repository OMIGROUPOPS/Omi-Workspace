...
- **C-THE-WALK v1 (standing protocol, armed)** — founding walk DONE (FOMLIM). Part 0 DONE (THE DOCKET, 86 D/F legs unprompted). **BATCH 1 IN PROGRESS: specimens delivered (`5eeb3fd0`, SPECIMENS.md — three entry questions on five legs); the remaining trio parts (AMENDMENT + PROOF per flagged game: Samson/Feistel · Wu/Bu · Serafini/Basile · Viiala/Sach) + JINLEE missing-bell filing + LIVING-DOCKET wire are this session's Task 2.**
