...
USE_BLENDED_TARGET = {
    ...
    # ===== ATP CHALLENGER =====
    ('ATP_CHALL', 'leader',   55, 59): True,   # B wins (+32.86 vs A +27.58, +5.28/day)
    ('ATP_CHALL', 'leader',   60, 64): True,   # B wins (+30.64 vs A +25.14, +5.50/day) - was C-top but use B
    ('ATP_CHALL', 'leader',   65, 69): True,   # B wins narrowly (+37.35 vs A +36.48, +0.87/day)
    ('ATP_CHALL', 'leader',   70, 74): True,   # B wins (+19.12 vs A +18.17, +0.95/day)
    ...
    ('ATP_CHALL', 'underdog', 35, 39): True,   # B wins BIG (+28.63 vs A +21.01, +7.62/day) ★
    ...
    ('WTA_MAIN',  'leader',   60, 64): True,   # B wins (+5.20 vs A +4.57, +0.63/day)
    ('WTA_MAIN',  'leader',   65, 69): False,  # hold-to-99c, flag irrelevant
    ('WTA_MAIN',  'leader',   70, 74): True,   # B wins (+4.22 vs A +1.70, +2.52/day) ★
