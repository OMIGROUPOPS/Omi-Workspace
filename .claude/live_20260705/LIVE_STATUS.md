...
- cycle 67 @ **2026-07-05 10:12:51 PM ET** | build `1c045db` | session boot 07-05 19:24 ET | log `live_v3_20260705.jsonl` | 4312 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL05LEGSHI-L | 43 | 118m | 4984/35-98/492205 | 95-36 | -8 | **FLOW_AT_LEVEL** | 48 |  |
| ATPCHALLENGERMATCH-26JUL05LEGSHI-L | 42 | 113m | 4872/35-98/486840 | 95-36 | -7 | **FLOW_AT_LEVEL** | 48 |  |

## COULD-HAVE-FILLED — open pairs, achievable-combined RIGHT NOW
no open half-pairs

## PATTERNS (sub-B) — 3
- half_arm_aging: KXITFMATCH-26JUL05MASCIO-MAS {"fill": 33, "age_min": 168, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL05VANGAU-GAU {"fill": 7, "age_min": 167, "mode": "NO_BID(sib rested earlier, none now)"}
