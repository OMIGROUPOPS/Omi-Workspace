...
- cycle 26 @ **2026-07-10 09:20:45 PM ET** | build `66fa14e8` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 9556 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 133m | 197/27-30/18263 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 4.433 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 200, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 133, "mode": "SET_BELOW_FLOW(prints 3c above)"}
