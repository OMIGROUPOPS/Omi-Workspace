...
Writes /tmp/on2_ledger.tsv, /tmp/on2_participation.tsv, /tmp/on2_agg.txt, /tmp/on2_dump.json"""
...
LOG='logs/live_v3_20260703.jsonl'
# window: ba08243 boot 18:32:05 ET Jul 3 -> hotfix shutdown 12:58:55 ET Jul 4 (whole file)
BOOT_LIVE = datetime(2026,7,3,18,32,5,tzinfo=ET).timestamp()
...
json.dump({'legs':rows_out,'events':evrows,'discovery':discovery,
    ...
    open('/tmp/on2_dump.json','w'),default=str)

tf=open('/tmp/on2_ledger.tsv','w')
...
pf=open('/tmp/on2_participation.tsv','w')
