...
**Candidate SHA: `e156a071`** (post-boot book audit, assert-and-halt: gate-banked snapshot diff, five per-leg assertions, conception halt, jsonl-verified).
...
| conception_on_owned | 22 | BARZIN-BAR, HOLSCH-SCH, ILARYB-ILA, JUNMOR-MOR, BASGAU-GAU, MARCRE-CRE |

**VERDICT: FAIL (56) → conceptions halt, alert artifact committed+pushed, halt clears only on a passing re-audit.**
