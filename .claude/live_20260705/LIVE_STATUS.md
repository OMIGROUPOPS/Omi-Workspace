...
- cycle 102 @ **2026-07-12 05:53:21 AM ET** | build `83ae825c` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 192037 session events | monitor READ-ONLY

## MORNING REVIEW — overnight watch fires (12:00 AM–9:00 AM ET) — 36 item(s)
...
- **half_arm_aging**: KXITFMATCH-26JUL12MILARZ-ARZ {"fill": 27, "age_min": 278, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12DELMAK-DEL {"fill": 8, "age_min": 216, "mode": "SET_BELOW_FLOW(prints 4c above)"}
...
- **half_arm_aging**: KXWTAMATCH-26JUL12GARPRI-GAR {"fill": 39, "age_min": 172, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL12KULZAA-ZAA {"fill": 67, "age_min": 167, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL12TOMKAR-KAR {"fill": 54, "age_min": 150, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12VILRAH-VIL {"fill": 68, "age_min": 105, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFMATCH-26JUL12REYBAR-BAR {"kind": "resting_bid", "ref": 6.0, "market_mid": 73.0, "divergence": -67.0}
- **half_arm_aging**: KXITFMATCH-26JUL12LOPLAG-LOP {"fill": 62, "age_min": 89, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL12DURDOU-DOU {"fill": 72, "age_min": 81, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL12ROJPER-PER {"fill": 56, "age_min": 73, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL12RYSHRU-HRU {"fill": 58, "age_min": 72, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL12REYBAR-BAR {"fill": 77, "age_min": 66, "mode": "PAIRING(sib never rested)"}
- **reality_divergence**: KXWTAMATCH-26JUL12KULZAA-ZAA {"kind": "position_basis", "ref": 67.0, "market_mid": 41.0, "divergence": 26.0}
- **half_arm_aging**: KXITFMATCH-26JUL12FABGIU-FAB {"fill": 59, "age_min": 51, "mode": "PAIRING(sib never rested)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12BALPET-BAL {"fill": 13, "age_min": 50, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12RAQKUM-KUM {"fill": 52, "age_min": 46, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTACHALLENGERMATCH-26JUL12BOSKOV-BOS {"fill": 93, "age_min": 45, "mode": "PAIRING(sib never rested)"}
- **half_arm_aging**: KXATPMATCH-26JUL12SKASAC-SKA {"fill": 49, "age_min": 44, "mode": "STARVATION(no prints since post)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL12DODDEL-DOD {"fill": 37, "age_min": 41, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- **reality_divergence**: KXATPCHALLENGERMATCH-26JUL12GANJAN-JAN {"kind": "position_basis", "ref": 77.0, "market_mid": 50.5, "divergence": 26.5}
- **reality_divergence**: KXATPCHALLENGERMATCH-26JUL12GANJAN-JAN {"kind": "position_basis", "ref": 77.0, "market_mid": 29.0, "divergence": 48.0, "emitted_et": "2026-07-12 05:53:21 AM ET"}
- **reality_divergence**: KXITFWMATCH-26JUL12RYSHRU-HRU {"kind": "position_basis", "ref": 58.0, "market_mid": 32.0, "divergence": 26.0, "emitted_et": "2026-07-12 05:53:21 AM ET"}
...
| 04:23 | ITFWMATCH-26JUL12LIUPUS-LIU | ITF_W | underdog | 22 | 11 | +11 (place_cell) | — | pre | pair | 97 | PENDING |
| 04:23 | ITFMATCH-26JUL12LOPLAG-LOP | ITF_M | leader | 62 | 60 | +2 (place_cell) | — | pre | single |  | PENDING |
| 04:28 | ITFWMATCH-26JUL12GUPFER-GUP | ITF_W | underdog | 18 | 42 | -24 (place_cell) | — | pre | pair | 97 | PENDING |
...
| 04:46 | ITFMATCH-26JUL12REYBAR-BAR | ITF_M | leader | 77 | 47 | +30 (place_cell) | — | pre | single |  | PENDING |
| 05:01 | ITFMATCH-26JUL12FABGIU-FAB | ITF_M | leader | 59 | 91 | -32 (place_cell) | — | pre | single |  | PENDING |
| 05:03 | ATPCHALLENGERMATCH-26JUL12BALPET-B | ATP_CHALL | underdog | 13 | 8 | +5 (place_cell) | — | pre | single |  | MIXED |
| 05:04 | ITFWMATCH-26JUL12LIUPUS-PUS | ITF_W | ? | 75 | 79 | -4 (place_cell) | — | pre | pair | 97 | PENDING |
...
| 05:27 | ITFWMATCH-26JUL12GUPFER-FER | ITF_W | leader | 79 | 81 | -2 (place_cell) | — | pre | pair | 97 | PENDING |
...
- classes now: {'FLOW_AT_LEVEL': 8, 'FLOW_ABOVE': 40, 'NO_FLOW': 50} | repriceable now: true 26 / false 72 | **cumulative bid_grade lines: 8457 (repriceable true 1224 / false 7233)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 1308m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL12BINGIL-B | 82 | 73m | 0 | 82-85 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12BINGIL-G | 15 | 73m | 0 | 15-16 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12BROGIU-B | 47 | 41m | 0 | 47-48 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12BROGIU-G | 52 | 82m | 4/52-53/201 | 52-53 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12CHAJON-C | 41 | 172m | 1/43-43/42 | 41-42 | 2 | **FLOW_ABOVE** | 40 | flow above but bound 40c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12CHAJON-J | 56 | 172m | 7/59-60/485 | 59-60 | 3 | **FLOW_ABOVE** | 56 | flow above but bound 56c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12CHISEA-C | 31 | 52m | 1/32-32/0 | 31-32 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→32 |
| ATPCHALLENGERMATCH-26JUL12CHISEA-S | 67 | 52m | 0 | 67-68 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12CHOGAS-G | 38 | 52m | 0 | 38-39 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12CRIBAS-B | 64 | 262m | 9/64-66/115 | 64-65 | 0 | **FLOW_AT_LEVEL** | 62 |  |
| ATPCHALLENGERMATCH-26JUL12CRIBAS-C | 35 | 208m | 0 | 35-36 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12DELMAK-M | 89 | 216m | 1/93-93/1 | 92-93 | 4 | **FLOW_ABOVE** | 89 | flow above but bound 89c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12DODDEL-D | 60 | 41m | 14/64-64/1369 | 63-64 | 4 | **FLOW_ABOVE** | 60 | flow above but bound 60c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12FUEROS-F | 57 | 73m | 1/59-59/3 | 57-59 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→59 |
| ATPCHALLENGERMATCH-26JUL12FUEROS-R | 40 | 73m | 0 | 41-43 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12GUTCAM-C | 66 | 52m | 4/69-69/289 | 66-68 | 3 | **FLOW_ABOVE** | 66 | flow above but bound 66c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12GUTCAM-G | 31 | 103m | 0 | 31-33 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12KRALOR-K | 94 | 172m | 0 | 94-95 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12KUZDE-DE | 15 | 112m | 1/18-18/126 | 15-18 | 3 | **FLOW_ABOVE** | 15 | flow above but bound 15c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL12KUZDE-KU | 82 | 52m | 0 | 82-85 | — | **NO_FLOW** | 79 |  |
| ATPCHALLENGERMATCH-26JUL12MARFOR-F | 40 | 52m | 0 | 41-43 | — | **NO_FLOW** | 35 |  |
| ATPCHALLENGERMATCH-26JUL12MARFOR-M | 57 | 52m | 0 | 57-59 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12MOLDON-D | 10 | 22m | 0 | 10-11 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12MOLDON-M | 88 | 22m | 0 | 88-90 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12PIETAB-P | 65 | 172m | 1/66-66/16 | 66-68 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→66 |
| ATPCHALLENGERMATCH-26JUL12PIETAB-T | 32 | 172m | 1/33-33/3 | 32-33 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→33 |
| ATPCHALLENGERMATCH-26JUL12POLVIN-P | 38 | 172m | 0 | 41-44 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12POLVIN-V | 59 | 172m | 1/60-60/3 | 59-60 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→60 |
| ATPCHALLENGERMATCH-26JUL12SALARN-A | 84 | 34m | 0 | 84-86 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12SALARN-S | 14 | 73m | 0 | 14-16 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12VALNIJ-N | 70 | 22m | 0 | 70-73 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12VALNIJ-V | 27 | 22m | 0 | 27-30 | — | **NO_FLOW** | 99 |  |
| ATPCHALLENGERMATCH-26JUL12YEVBOR-B | 5 | 112m | 0 | 5-7 | — | **NO_FLOW** | 4 |  |
| ATPCHALLENGERMATCH-26JUL12YEVBOR-Y | 93 | 112m | 0 | 93-95 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12ALTGAS-ALT | 57 | 275m | 1/58-58/36 | 57-59 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→58 |
| ATPMATCH-26JUL12ALTGAS-GAS | 42 | 287m | 0 | 42-43 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12CARSAN-SAN | 19 | 52m | 0 | 19-20 | — | **NO_FLOW** | 18 |  |
| ATPMATCH-26JUL12DEJGAU-GAU | 32 | 252m | 1/33-33/1 | 32-34 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→33 |
| ATPMATCH-26JUL12DIEMON-DIE | 55 | 52m | 9/56-56/1200 | 55-56 | 1 | **FLOW_ABOVE** | 56 | REPRICEABLE→56 |
| ATPMATCH-26JUL12DIEMON-MON | 44 | 52m | 18/45-46/1476 | 44-45 | 1 | **FLOW_ABOVE** | 42 | flow above but bound 42c < flow -- chasing breaks goal |
| ATPMATCH-26JUL12FARWAW-FAR | 63 | 389m | 9/64-67/1339 | 67-68 | 1 | **FLOW_ABOVE** | 66 | REPRICEABLE→64 |
| ATPMATCH-26JUL12MOLFAU-FAU | 33 | 142m | 5/34-34/920 | 33-34 | 1 | **FLOW_ABOVE** | 32 | flow above but bound 32c < flow -- chasing breaks goal |
| ATPMATCH-26JUL12MOLFAU-MOL | 66 | 52m | 3/66-67/64 | 66-67 | 0 | **FLOW_AT_LEVEL** | 67 |  |
| ATPMATCH-26JUL12OFNTIR-OFN | 42 | 327m | 2/44-44/64 | 42-43 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→44 |
| ATPMATCH-26JUL12OFNTIR-TIR | 56 | 268m | 0 | 57-58 | — | **NO_FLOW** | 99 |  |
| ATPMATCH-26JUL12PASKAS-KAS | 48 | 157m | 10/49-50/2085 | 48-49 | 1 | **FLOW_ABOVE** | 50 | REPRICEABLE→49 |
| ATPMATCH-26JUL12PASKAS-PAS | 51 | 52m | 4/52-52/36 | 51-52 | 1 | **FLOW_ABOVE** | 51 | flow above but bound 51c < flow -- chasing breaks goal |
| ATPMATCH-26JUL12REJMID-MID | 92 | 52m | 0 | 92-93 | — | **NO_FLOW** | 93 |  |
| ATPMATCH-26JUL12REJMID-REJ | 7 | 52m | 4/8-8/119 | 7-8 | 1 | **FLOW_ABOVE** | 5 | flow above but bound 5c < flow -- chasing breaks goal |
| ATPMATCH-26JUL12SKASAC-SAC | 48 | 44m | 0 | 52-51 | — | **NO_FLOW** | 48 |  |
| ATPMATCH-26JUL12SONSCH-SCH | 32 | 355m | 2/35-35/21 | 33-35 | 3 | **FLOW_ABOVE** | 33 | REPRICEABLE→33 |
| ATPMATCH-26JUL12SVRDIM-SVR | 34 | 172m | 0 | 34-35 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12DONWIS-WIS | 49 | 172m | 2/51-51/94 | 49-51 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→51 |
| ITFMATCH-26JUL12KNIPRA-KNI | 44 | 35m | 0 | 44-55 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12PAPSNI-PAP | 27 | 172m | 2/30-31/31 | 27-30 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→30 |
| ITFMATCH-26JUL12PAPSNI-SNI | 70 | 145m | 0 | 70-72 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12WESJUA-JUA | 53 | 229m | 2/54-54/89 | 53-54 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→54 |
| ITFMATCH-26JUL12WESJUA-WES | 45 | 232m | 0 | 45-47 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12CORBOU-BOU | 81 | 84m | 0 | 81-92 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12GUPFER-GUP | 11 | 25m | 80/6-27/3945 | 25-6 | -5 | **FLOW_AT_LEVEL** | 18 |  |
| ITFWMATCH-26JUL12HANLUN-LUN | 13 | 31m | 90/3-16/7175 | 17-4 | -10 | **FLOW_AT_LEVEL** | 16 |  |
| ITFWMATCH-26JUL12HAYKUP-HAY | 63 | 22m | 0 | 63-64 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12LEEGAO-GAO | 46 | 111m | 0 | 46-49 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12LEEGAO-LEE | 51 | 38m | 1/54-54/179 | 51-54 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→54 |
| ITFWMATCH-26JUL12LEYHOS-HOS | 46 | 323m | 10/49-50/432 | 46-49 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→49 |
| ITFWMATCH-26JUL12LEYHOS-LEY | 52 | 157m | 6/54-55/74 | 52-55 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→54 |
| ITFWMATCH-26JUL12MATVAN-MAT | 12 | 43m | 147/5-30/15892 | 18-8 | -7 | **FLOW_AT_LEVEL** | 13 |  |
| ITFWMATCH-26JUL12SOBGOR-GOR | 29 | 172m | 0 | 29-35 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12SOBGOR-SOB | 66 | 172m | 1/70-70/6 | 66-70 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→70 |
| ITFWMATCH-26JUL12SOUBAB-BAB | 76 | 22m | 0 | 76-79 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12SOUBAB-SOU | 21 | 22m | 0 | 21-22 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12VEDBOS-BOS | 34 | 142m | 0 | 34-38 | — | **NO_FLOW** | 99 |  |
| ITFWMATCH-26JUL12VEDBOS-VED | 62 | 137m | 0 | 62-65 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ARIZHA-A | 34 | 53m | 0 | 34-36 | — | **NO_FLOW** | 34 |  |
| WTACHALLENGERMATCH-26JUL12ARIZHA-Z | 63 | 288m | 3/65-65/319 | 63-65 | 2 | **FLOW_ABOVE** | 62 | flow above but bound 62c < flow -- chasing breaks goal |
| WTACHALLENGERMATCH-26JUL12CIRHUA-C | 6 | 142m | 0 | 6-7 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12CIRHUA-H | 93 | 52m | 0 | 93-94 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12FEICHE-C | 24 | 202m | 5/25-26/367 | 24-25 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→25 |
| WTACHALLENGERMATCH-26JUL12FEICHE-F | 74 | 202m | 2/76-76/25 | 74-76 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→76 |
| WTACHALLENGERMATCH-26JUL12PALCOL-C | 21 | 171m | 0 | 21-24 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12PALCOL-P | 76 | 202m | 0 | 76-79 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12PANYOR-P | 83 | 142m | 1/85-85/22 | 84-85 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→85 |
| WTACHALLENGERMATCH-26JUL12PANYOR-Y | 15 | 87m | 4/16-17/144 | 15-17 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→16 |
| WTACHALLENGERMATCH-26JUL12ROUJAK-J | 54 | 42m | 0 | 54-55 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ROUJAK-R | 45 | 52m | 0 | 45-46 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12SHITUR-S | 82 | 232m | 5/83-85/39 | 82-83 | 1 | **FLOW_ABOVE** | 80 | flow above but bound 80c < flow -- chasing breaks goal |
| WTACHALLENGERMATCH-26JUL12SHITUR-T | 17 | 53m | 1/18-18/5 | 17-18 | 1 | **FLOW_ABOVE** | 15 | flow above but bound 15c < flow -- chasing breaks goal |
| WTACHALLENGERMATCH-26JUL12SOKNUG-N | 66 | 52m | 1/67-67/22 | 66-67 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→67 |
| WTACHALLENGERMATCH-26JUL12SOKNUG-S | 33 | 52m | 0 | 33-34 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ZELFAL-F | 78 | 142m | 0 | 78-80 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL12ZELFAL-Z | 20 | 142m | 1/21-21/451 | 20-21 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→21 |
| WTAMATCH-26JUL12FETPIE-FET | 33 | 52m | 7/35-35/528 | 33-35 | 2 | **FLOW_ABOVE** | 33 | flow above but bound 33c < flow -- chasing breaks goal |
| WTAMATCH-26JUL12FETPIE-PIE | 65 | 52m | 5/67-68/138 | 66-67 | 2 | **FLOW_ABOVE** | 67 | REPRICEABLE→67 |
| WTAMATCH-26JUL12KOZIBR-KOZ | 8 | 52m | 0 | 8-9 | — | **NO_FLOW** | 7 |  |
| WTAMATCH-26JUL12LEPBUR-BUR | 23 | 43m | 0 | 23-24 | — | **NO_FLOW** | 21 |  |
| WTAMATCH-26JUL12LIUPOP-LIU | 86 | 22m | 0 | 86-87 | — | **NO_FLOW** | 87 |  |
| WTAMATCH-26JUL12LIUPOP-POP | 13 | 143m | 2/13-14/15 | 13-14 | 0 | **FLOW_AT_LEVEL** | 12 |  |
...
| ATPCHALLENGERMATCH-26JUL12BALPET | 13 | 65 | **78** | 97 | -19 |
| ATPCHALLENGERMATCH-26JUL12RAQKUM | 52 | 28 | **80** | 97 | -17 |
...
| ATPCHALLENGERMATCH-26JUL12VILRAH | 68 | 22 | **90** | 97 | -7 |
...
| ATPMATCH-26JUL12SKASAC | 49 | 51 | **100** | 97 | +3 |
| ATPMATCH-26JUL12CORDAN | 70 | 30 | **100** | 97 | +3 |
...
## FLOW-STATE — 172 tracked game(s) ({'QUIET': 74, 'WAKING': 94, 'OPEN': 4}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL12DODDEL | ATP_CHALL | 0.6 | 1 | **OPEN** |
| ATPMATCH-26JUL12DIEMON | ATP_MAIN | 0.833 | 1 | **OPEN** |
| ITFMATCH-26JUL12BORNOR | ITF_M | 0.267 | 2 | **OPEN** |
| ITFWMATCH-26JUL12LEYHOS | ITF_W | 0.433 | 3 | **OPEN** |
...
| ITFMATCH-26JUL12KNIPRA | ITF_M | 0.0 | 11 | **QUIET** |
...
| ATPCHALLENGERMATCH-26JUL12ALVVAN | ATP_CHALL | 2.267 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12BALPET | ATP_CHALL | 4.5 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12BINGIL | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12BROGIU | ATP_CHALL | 0.133 | 1 | **WAKING** |
...
| ATPCHALLENGERMATCH-26JUL12CRIBAS | ATP_CHALL | 0.167 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12DELMAK | ATP_CHALL | 0.233 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12FUEROS | ATP_CHALL | 0.0 | 2 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL12GANJAN | ATP_CHALL | 35.933 | — | **WAKING** |
...
| ATPMATCH-26JUL12CORDAN | ATP_MAIN | 0.267 | 1 | **WAKING** |
...
| ATPMATCH-26JUL12PASKAS | ATP_MAIN | 0.233 | 1 | **WAKING** |
| ATPMATCH-26JUL12REJMID | ATP_MAIN | 0.067 | 1 | **WAKING** |
| ATPMATCH-26JUL12SKASAC | ATP_MAIN | 0.233 | — | **WAKING** |
...
| ITFMATCH-26JUL12DURDOU | ITF_M | 6.9 | — | **WAKING** |
| ITFMATCH-26JUL12FABGIU | ITF_M | 1.967 | — | **WAKING** |
| ITFMATCH-26JUL12LOPLAG | ITF_M | 6.6 | — | **WAKING** |
| ITFMATCH-26JUL12MILARZ | ITF_M | 8.333 | — | **WAKING** |
| ITFMATCH-26JUL12MONSHI | ITF_M | 12.033 | — | **WAKING** |
| ITFMATCH-26JUL12PAPSNI | ITF_M | 0.0 | 2 | **WAKING** |
| ITFMATCH-26JUL12REYBAR | ITF_M | 4.6 | — | **WAKING** |
...
| ITFWMATCH-26JUL12COHMOO | ITF_W | 1.233 | — | **WAKING** |
| ITFWMATCH-26JUL12CORBRU | ITF_W | 42.2 | — | **WAKING** |
| ITFWMATCH-26JUL12GUPFER | ITF_W | 5.567 | — | **WAKING** |
| ITFWMATCH-26JUL12HANLUN | ITF_W | 3.467 | — | **WAKING** |
| ITFWMATCH-26JUL12HAYKUP | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL12LEEGAO | ITF_W | 0.033 | 3 | **WAKING** |
| ITFWMATCH-26JUL12LIUPUS | ITF_W | 6.967 | — | **WAKING** |
| ITFWMATCH-26JUL12MALBEK | ITF_W | 10.7 | 7 | **WAKING** |
| ITFWMATCH-26JUL12MATVAN | ITF_W | 4.8 | — | **WAKING** |
| ITFWMATCH-26JUL12ROJPER | ITF_W | 5.667 | — | **WAKING** |
| ITFWMATCH-26JUL12RYSHRU | ITF_W | 23.333 | — | **WAKING** |
| ITFWMATCH-26JUL12SOBGOR | ITF_W | 0.0 | 4 | **WAKING** |
| ITFWMATCH-26JUL12SOUBAB | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL12TOMKAR | ITF_W | 9.9 | — | **WAKING** |
...
| WTAMATCH-26JUL12FETPIE | WTA_MAIN | 0.367 | 1 | **WAKING** |
...
- half_arm_aging: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 1733, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 1731, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 1708, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 1686, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 1683, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 1664, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 1626, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 1590, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 1580, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 1577, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 1570, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 1560, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 1550, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 1548, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 1546, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 1521, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 1516, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 1507, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- half_arm_aging: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 1503, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 1493, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 1485, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- half_arm_aging: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 1461, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 1459, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 1449, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- half_arm_aging: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 1435, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 1435, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 1430, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- half_arm_aging: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 1423, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 1404, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 1393, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 1359, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 1349, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 1309, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 1308, "mode": "QUEUE(flow at/below our level, unfilled)"}
- half_arm_aging: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 1301, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 1293, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 1292, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 1292, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 1291, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 1289, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 1261, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 1253, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 1247, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 1186, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 1164, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 1163, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 1138, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 1122, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 1119, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 1114, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 1108, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 1106, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 1095, "mode": "NO_BID(sib rested earlier, none now)"}
- deep_neg_fv: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"entry_minus_fv_burst": -23.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 1084, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 1083, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 1078, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 1068, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 1049, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 1010, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 1006, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHCCHA-CHA {"fill": 19, "age_min": 951, "mode": "NO_BID(sib rested earlier, none now)"}
- pre_conception_buy: KXITFWMATCH-26JUL12CORBRU-BRU {"price": 41, "conception_ts": 1783846800.9134462, "detail": "buy 41c predates the conception stamp by 239min \u2014 honest-window buy, cap not yet defined (ungradeable)"}
- pre_conception_buy: KXITFWMATCH-26JUL12CORBRU-BRU {"price": 51, "conception_ts": 1783846800.9134462, "detail": "buy 51c predates the conception stamp by 239min \u2014 honest-window buy, cap not yet defined (ungradeable)"}
- half_arm_aging: KXITFMATCH-26JUL12MILARZ-ARZ {"fill": 27, "age_min": 278, "mode": "NO_BID(sib rested earlier, none now)"}
- pre_conception_buy: KXITFWMATCH-26JUL12CORBRU-BRU {"price": 52, "conception_ts": 1783846800.9134462, "detail": "buy 52c predates the conception stamp by 204min \u2014 honest-window buy, cap not yet defined (ungradeable)"}
