...
- cycle 242 @ **2026-07-17 07:28:30 PM ET** | build `f4307d22` | session boot 07-17 15:16 ET | log `live_v3_20260717.jsonl` | 12013 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17FORTOM-F | 31 | 209m | 18/33-35/1656 | 34-35 | 2 | **FLOW_ABOVE** | 31 | flow above but bound 31c < flow -- chasing breaks goal |
| ITFMATCH-26JUL18AGIOVC-AGI | 22 | 25m | 2/23-23/24 | 22-23 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→23 |
| ITFMATCH-26JUL18AGIOVC-OVC | 68 | 26m | 0 | 76-81 | — | **NO_FLOW** | 99 |  |

## COULD-HAVE-FILLED — open pairs, achievable-combined RIGHT NOW
| event | basis | sib ask | achievable | goal | vs goal |
|---|---|---|---|---|---|
| ITFMATCH-26JUL17NEFGAI | 46 | 2 | **48** | 97 | -49 |
| ATPCHALLENGERMATCH-26JUL17SMIYUN | 63 | 25 | **88** | 97 | -9 |
| ATPCHALLENGERMATCH-26JUL17FORTOM | 66 | 35 | **101** | 97 | +4 |
| ATPCHALLENGERMATCH-26JUL17LAJNOG | 71 | 32 | **103** | 97 | +6 |
| ATPCHALLENGERMATCH-26JUL17WONJOH | 64 | 61 | **125** | 97 | +28 |
| ATPCHALLENGERMATCH-26JUL17HOLBOU | 33 | 97 | **130** | 97 | +33 |
| ATPCHALLENGERMATCH-26JUL17VUKGAL | 53 | 81 | **134** | 97 | +37 |

## FLOW-STATE — 9 tracked game(s) ({'WAKING': 3, 'QUIET': 2, 'OPEN': 4}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17LAJNOG | ATP_CHALL | 14.433 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL17SMIYUN | ATP_CHALL | 5.667 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL17WONJOH | ATP_CHALL | 14.1 | 1 | **OPEN** |
| ITFMATCH-26JUL17OCODEL | ITF_M | 1.167 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL17VUKGAL | ATP_CHALL | 77.933 | — | **WAKING** |
| ITFMATCH-26JUL18AGIOVC | ITF_M | 0.067 | 1 | **WAKING** |

## PATTERNS (sub-B) — 16
- half_arm_aging: KXITFMATCH-26JUL17NEFGAI-GAI {"fill": 46, "age_min": 252, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17DELFUE-DEL {"kind": "position_basis", "ref": 86.0, "market_mid": 29.0, "divergence": 57.0}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17HOLBOU-BOU {"fill": 33, "age_min": 237, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17WONJOH-WON {"fill": 64, "age_min": 201, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17SMIYUN-YUN {"fill": 63, "age_min": 176, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17VUKGAL-GAL {"fill": 53, "age_min": 154, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17SANALM-ALM {"kind": "position_basis", "ref": 68.0, "market_mid": 12.5, "divergence": 55.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17FORTOM-TOM {"fill": 66, "age_min": 81, "mode": "SET_BELOW_FLOW(prints 2c above)"}
