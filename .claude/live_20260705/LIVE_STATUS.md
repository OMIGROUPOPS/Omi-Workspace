...
- cycle 354 @ **2026-07-18 03:07:44 PM ET** | build `7ad2fb3e` | session boot 07-18 13:59 ET | log `live_v3_20260718.jsonl` | 2605 session events | monitor READ-ONLY
...
- classes now: {'FLOW_ABOVE': 5, 'NO_FLOW': 2} | repriceable now: true 4 / false 3 | **cumulative bid_grade lines: 12883 (repriceable true 1738 / false 11145)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL18LAJYUN-L | 33 | 61m | 1/37-37/2 | 36-37 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→37 |
| ATPCHALLENGERMATCH-26JUL18LAJYUN-Y | 63 | 66m | 7/64-64/592 | 63-64 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→64 |
| ATPCHALLENGERMATCH-26JUL18TOMJOH-J | 55 | 68m | 11/58-59/1455 | 58-59 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→58 |
| ATPCHALLENGERMATCH-26JUL18TOMJOH-T | 39 | 68m | 12/43-43/412 | 42-43 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→43 |
| ITFWMATCH-26JUL18SAIHOS-SAI | 52 | 4m | 0 | 63-65 | — | **NO_FLOW** | 61 |  |
| ITFWMATCH-26JUL18THOAIA-AIA | 84 | 47m | 15/86-89/437 | 85-89 | 2 | **FLOW_ABOVE** | 84 | flow above but bound 84c < flow -- chasing breaks goal |
| WTACHALLENGERMATCH-26JUL18TONSPI-T | 31 | 68m | 0 | 31-59 | — | **NO_FLOW** | 99 |  |
...
| ITFWMATCH-26JUL18SAIHOS | ITF_W | 0.7 | 2 | **OPEN** |
| ITFWMATCH-26JUL18THOAIA | ITF_W | 0.567 | 2 | **OPEN** |
| WTACHALLENGERMATCH-26JUL18TONSPI | WTA_CHALL | 0.0 | 28 | **QUIET** |
| ATPCHALLENGERMATCH-26JUL18LAJYUN | ATP_CHALL | 0.1 | 1 | **WAKING** |

## PATTERNS (sub-B) — 2
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL18RODSAN-SAN {"fill": 21, "age_min": 50, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL18THOAIA-THO {"fill": 13, "age_min": 47, "mode": "SET_BELOW_FLOW(prints 2c above)"}
