...
class Config:
    ...
    dry_run_mode: bool = True     # V2: Default True for safe testing — logs orders without submitting
    ...
    # TIMING & STALENESS
    # ==========================================================================
    max_price_staleness_ms: int = 500   # V2: Tightened from 2000ms — trust WS data
