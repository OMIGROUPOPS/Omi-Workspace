...
**SESSION-ZERO READ: `truth/INDEX.json` FIRST** — laws (307) · surfaces (7) · sites (6) · studies (60). SECOND READ: truth/OPEN_LEDGER.md (every open thread; gate-checked every C50). Everything below is a pointer INTO the index's members:
