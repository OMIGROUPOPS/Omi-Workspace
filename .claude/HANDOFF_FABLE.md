...
**STATE 2026-08-07 — V38 maker-only replay frozen:** V38 deletes the take path and replays D=804 as rests only. Market union-reach grade is 150 completed / 150 under par; answer-key grade is MATCHED 17 / SHALLOW 113 / MISSING 507, with 4,505 cents measurable residual. Strict print-crossing is build verification only (91 / 91). The largest remaining owner is `RISING_REST_FILLED_SHALLOW` (298 sides / 2,190 cents). Two clean builds are byte-identical and forbidden access is zero. This is not a cutover or live authorization. See `.claude/window1_live_v4_replay/v38_maker_only_machine_20260807/` and `arb-executor/docs/research/window1/WINDOW1_V38_MAKER_ONLY_20260807_ADDENDUM.md`.

**STATE 2026-08-07 — V36 gap-to-union-reach grade:** frozen STRICT V36 `bfde0d8d1135f5c5f48a5f3d619ab30050efab83` versus aggregate-exact union reach `57daf3c15ad618098a810566d24127df8f17f3f9`: MATCHED 52 / SHALLOW 212 / ONE_MISSING 486 / BOTH_MISSING 35 / NO_REACH 19. The ruler reproduces 373,203 prints, 637 under-par games, and 5,253¢ locked. Largest measured owner is TAKE_FIRED_ABOVE_REACH (3,046¢, 539 games); 86 missing sides are a strict-build-verification fill-model seam, not a V36 organ. See `.claude/window1_live_v4_replay/v36_gap_to_union_reach_20260807/` and `arb-executor/docs/research/window1/V36_GAP_TO_UNION_REACH_20260807_ADDENDUM.md`.
...
## 2026-08-07 STAGE C CLOSE-OUT HANDOFF (newer; governs)

The twelve-file blocker is closed: KEEP 0 / RETIRE 12, exact preimages sealed, exact twelve paths restored to committed HEAD, and VPS tracked status empty at `27596166f03e040a5e38824748dcd88d70bed93b`. Engine process count remains zero; keepalive cron remains inhibited at SHA-256 `405bd4cf5bf9cc59f26f413c07388b35e595f868201af6f10349a878bfecb149`. The prepared shadow code remains dormant source only; this close-out launched no shadow and touched no capital, order, position, or cron surface. The six-game V36 evidence pack is frozen from committed traces and certified private inputs, with two byte-identical builds and 11/11 focused tests. Canonical receipt: `.claude/boot_gate_stage_c_closeout_v36_evidence_20260807/STAGE_C_CLOSEOUT_REPORT.md`. A future boot/cutover still requires a separate explicit operator ceremony.
