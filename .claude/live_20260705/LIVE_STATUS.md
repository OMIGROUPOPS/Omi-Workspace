...
- cycle 73 @ **2026-07-12 12:46:49 AM ET** | build `310f3bcb` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 94748 session events | monitor READ-ONLY
...
- classes now: {'FLOW_AT_LEVEL': 3, 'FLOW_ABOVE': 8, 'NO_FLOW': 6} | repriceable now: true 8 / false 9 | **cumulative bid_grade lines: 8183 (repriceable true 1168 / false 7015)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 1001m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL12FORPAM-F | 94 | 45m | 2/95-96/2 | 95-96 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→95 |
| ATPCHALLENGERMATCH-26JUL12GANJAN-G | 19 | 35m | 2/21-21/31 | 19-21 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→21 |
| ATPCHALLENGERMATCH-26JUL12GANJAN-J | 78 | 18m | 1/82-82/0 | 78-82 | 4 | **FLOW_ABOVE** | 99 | REPRICEABLE→82 |
| ATPCHALLENGERMATCH-26JUL12VILRAH-R | 29 | 16m | 3/31-32/55 | 29-31 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→31 |
| ATPMATCH-26JUL12FARWAW-FAR | 63 | 82m | 4/64-64/893 | 65-64 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→64 |
| ATPMATCH-26JUL12OFNTIR-OFN | 42 | 20m | 1/44-44/17 | 42-44 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→44 |
| ATPMATCH-26JUL12SONSCH-SCH | 32 | 49m | 0 | 35-35 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12DURDOU-DUR | 26 | 12m | 0 | 26-29 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12LOPLAG-LAG | 36 | 20m | 0 | 36-38 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12MILARZ-ARZ | 27 | 10m | 0 | 27-29 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL12MONSHI-MON | 83 | 75m | 7/86-86/279 | 83-86 | 3 | **FLOW_ABOVE** | 99 | REPRICEABLE→86 |
| ITFMATCH-26JUL12MONSHI-SHI | 14 | 52m | 27/16-18/1181 | 14-15 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→16 |
| ITFWMATCH-26JUL12LEYHOS-HOS | 46 | 16m | 0 | 46-50 | — | **NO_FLOW** | 99 |  |
| WTAMATCH-26JUL12GARPRI-GAR | 39 | 106m | 46/39-40/3609 | 39-40 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| WTAMATCH-26JUL12KULZAA-KUL | 31 | 106m | 27/31-32/3632 | 32-32 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| WTAMATCH-26JUL12WERAMA-AMA | 21 | 16m | 0 | 22-23 | — | **NO_FLOW** | 99 |  |
...
## FLOW-STATE — 102 tracked game(s) ({'QUIET': 70, 'WAKING': 30, 'OPEN': 2}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ITFMATCH-26JUL12MONSHI | ITF_M | 0.867 | 1 | **OPEN** |
| WTAMATCH-26JUL12GARPRI | WTA_MAIN | 0.867 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL12GANJAN | ATP_CHALL | 0.133 | 2 | **WAKING** |
...
| ATPMATCH-26JUL12FARWAW | ATP_MAIN | 0.067 | — | **WAKING** |
| ATPMATCH-26JUL12OFNTIR | ATP_MAIN | 0.067 | 2 | **WAKING** |
...
| ITFMATCH-26JUL11JASMAT | ITF_M | 48.033 | — | **WAKING** |
...
- half_arm_aging: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 1426, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 1425, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 1401, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 1379, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 1376, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 1358, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 1320, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 1283, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 1274, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 1271, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 1263, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 1253, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 1243, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 1241, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 1239, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 1214, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 1210, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 1200, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- half_arm_aging: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 1196, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 1186, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 1179, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- half_arm_aging: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 1155, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 1153, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 1142, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- half_arm_aging: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 1128, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 1128, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 1123, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- half_arm_aging: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 1116, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 1097, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 1086, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 1052, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 1043, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 1002, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 1001, "mode": "QUEUE(flow at/below our level, unfilled)"}
- half_arm_aging: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 994, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 986, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 985, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 985, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 985, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 983, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 954, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 946, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 940, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 879, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 857, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 857, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 831, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 815, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 812, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 807, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 802, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 799, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 788, "mode": "NO_BID(sib rested earlier, none now)"}
- deep_neg_fv: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"entry_minus_fv_burst": -23.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 777, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 776, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 771, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 761, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 742, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11MEJVAR-VAR {"fill": 34, "age_min": 703, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SYDGON-SYD {"fill": 94, "age_min": 699, "mode": "PAIRING(sib never rested)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11SHCCHA-CHA {"fill": 19, "age_min": 645, "mode": "NO_BID(sib rested earlier, none now)"}
