  ...
  return (
    <div className="rounded-lg border border-gray-800 bg-[#111] p-3">
      ...
      <div className="grid grid-cols-2 gap-4 mb-3">
        <div>
          <span className="text-[10px] text-white uppercase">Kalshi Books</span>
          <p className="text-sm text-white font-mono">
            {kActive} / {kTotal} <span className="text-white">({kPct}%)</span>
          </p>
        ...
        <div>
          <span className="text-[10px] text-white uppercase">PM Books</span>
          <p className="text-sm text-white font-mono">
            {pmActive} / {pmTotal} <span className="text-white">({pmPct}%)</span>
          </p>
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-1">
      ...
      {missingPm.length > 0 && (
        <div>
          <span className="text-[10px] text-white uppercase">Missing PM Books ({missingPm.length})</span>
