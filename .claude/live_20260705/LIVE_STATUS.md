...
- cycle 32 @ **2026-07-10 10:22:29 PM ET** | build `10b2b945` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 13168 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10NAKMAT-NAK | 54 | 22m | 42/55-56/2904 | 55-55 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→55 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 60.533 | — | **WAKING** |
| ITFMATCH-26JUL10NAKMAT | ITF_M | 2.0 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 261, "mode": "PAIRING(sib never rested)"}
