...
- cycle 24 @ **2026-07-10 09:00:23 PM ET** | build `60f7c44b` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 8403 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10DELJAS-JAS | 24 | 112m | 153/27-30/12841 | 28-28 | 3 | **FLOW_ABOVE** | 26 | REPRICEABLE→26 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 3.733 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 179, "mode": "PAIRING(sib never rested)"}
- half_arm_aging: KXITFMATCH-26JUL10DELJAS-DEL {"fill": 71, "age_min": 112, "mode": "SET_BELOW_FLOW(prints 3c above)"}
