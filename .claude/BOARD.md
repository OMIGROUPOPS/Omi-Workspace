...
14. **LYING-CLOCK class** — GILOBR exhibit: legacy date-coarse `kalshi_schedule_primary` start vs true start; the horizon bound (and every tts gate) is only as good as its anchor. First live re-materialization proof 07-08 evening: 5 sibling-repost completions re-placed beyond T-8h through a blind chokepoint refusal. Folds with #11 + the staged C-KALSHI-OCC lane.
