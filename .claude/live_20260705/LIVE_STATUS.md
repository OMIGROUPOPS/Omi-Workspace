...
- cycle 9 @ **2026-07-11 01:27:24 PM ET** | build `37e56c5b` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 45670 session events | monitor READ-ONLY
...
- **half_arm_aging**: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 747, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 745, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 722, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 700, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 697, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 678, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 640, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 604, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 594, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 591, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 584, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 574, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 564, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 562, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 560, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 534, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 530, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 521, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- **half_arm_aging**: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 516, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 507, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 499, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- **half_arm_aging**: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 475, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 473, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 463, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- **half_arm_aging**: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 449, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 448, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 444, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- **half_arm_aging**: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 437, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 417, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 407, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 373, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 363, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 323, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 322, "mode": "QUEUE(flow at/below our level, unfilled)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 315, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 307, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 306, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 306, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 305, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 303, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 275, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 267, "mode": "NO_BID(sib rested earlier, none now)"}
...
| 11:39 | WTAMATCH-26JUL11MORSZI-SZI | WTA_MAIN | underdog | 22 | 20 | +2 (place_cell) | — | pre | pair | 97 | MIXED |
...
| 12:15 | ITFMATCH-26JUL11JOHKLA-KLA | ITF_M | underdog | 26 | 21 | +5 (place_cell) | — | pre | pair | 97 | PENDING |
...
| 13:16 | ITFMATCH-26JUL11JOHKLA-JOH | ITF_M | leader | 71 | 70 | +1 (place_cell) | — | pre | pair | 97 | PENDING |
| 13:22 | WTAMATCH-26JUL11MORSZI-MOR | WTA_MAIN | leader | 75 | 77 | -2 (place_cell) | — | pre | pair | 97 | MIXED |

## RESTING BIDS — 7 tape-graded (starvation = NO_FLOW only)
- classes now: {'FLOW_AT_LEVEL': 1, 'FLOW_ABOVE': 5, 'NO_FLOW': 1} | repriceable now: true 3 / false 4 | **cumulative bid_grade lines: 8148 (repriceable true 1154 / false 6994)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA-F | 67 | 96m | 4/69-71/70 | 69-71 | 2 | **FLOW_ABOVE** | 67 | flow above but bound 67c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 322m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL11WALMIC-M | 64 | 97m | 17/68-68/639 | 67-68 | 4 | **FLOW_ABOVE** | 64 | flow above but bound 64c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11VANZAM-VAN | 59 | 4m | 0 | 59-61 | — | **NO_FLOW** | 99 |  |
| ITFMATCH-26JUL11VANZAM-ZAM | 40 | 140m | 3/41-41/98 | 40-41 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→41 |
| ITFWMATCH-26JUL11SHCCHA-CHA | 19 | 176m | 5/20-20/231 | 19-20 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→20 |
| ITFWMATCH-26JUL11SHCCHA-SHC | 80 | 123m | 4/82-82/22 | 80-82 | 2 | **FLOW_ABOVE** | 99 | REPRICEABLE→82 |
...
| ITFMATCH-26JUL11CIGZAR | 26 | 59 | **85** | 97 | -12 |
...
| ATPMATCH-26JUL11PRAMAJ | 15 | 81 | **96** | 97 | -1 |
...
| ATPCHALLENGERMATCH-26JUL11MEJVAR | 34 | 82 | **116** | 97 | +19 |
...
| WTACHALLENGERMATCH-26JUL11MINVOL | 47 | 93 | **140** | 97 | +43 |
...
## FLOW-STATE — 87 tracked game(s) ({'WAKING': 22, 'QUIET': 44, 'OPEN': 21}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11MEJVAR | ATP_CHALL | 3.467 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL11WALMIC | ATP_CHALL | 0.433 | 1 | **OPEN** |
| ATPMATCH-26JUL11BRAGOM | ATP_MAIN | 25.633 | 1 | **OPEN** |
| ATPMATCH-26JUL11NARGUE | ATP_MAIN | 4.6 | 1 | **OPEN** |
| ATPMATCH-26JUL11NEUPOL | ATP_MAIN | 9.567 | 1 | **OPEN** |
| ITFMATCH-26JUL11BAXLOK | ITF_M | 19.767 | 1 | **OPEN** |
| ITFMATCH-26JUL11CIGZAR | ITF_M | 22.6 | 1 | **OPEN** |
| ITFMATCH-26JUL11ERECRA | ITF_M | 1.0 | 1 | **OPEN** |
| ITFMATCH-26JUL11JOHKLA | ITF_M | 6.567 | 1 | **OPEN** |
| ITFMATCH-26JUL11MIYLEG | ITF_M | 4.933 | 2 | **OPEN** |
| ITFMATCH-26JUL11SVAZHU | ITF_M | 12.667 | 1 | **OPEN** |
| ITFMATCH-26JUL11SYDGON | ITF_M | 1.0 | 1 | **OPEN** |
| ITFMATCH-26JUL11VANZAM | ITF_M | 0.233 | 1 | **OPEN** |
| ITFMATCH-26JUL11WEIGHA | ITF_M | 37.267 | 2 | **OPEN** |
| ITFMATCH-26JUL11YOUKIM | ITF_M | 18.5 | 1 | **OPEN** |
| ITFWMATCH-26JUL11MIRMAL | ITF_W | 11.6 | 1 | **OPEN** |
| ITFWMATCH-26JUL11SHCCHA | ITF_W | 0.233 | 1 | **OPEN** |
| WTACHALLENGERMATCH-26JUL11MINVOL | WTA_CHALL | 9.067 | 1 | **OPEN** |
| WTAMATCH-26JUL11MORSZI | WTA_MAIN | 2.0 | 1 | **OPEN** |
| WTAMATCH-26JUL11TANNEP | WTA_MAIN | 22.967 | 1 | **OPEN** |
| WTAMATCH-26JUL11YASGLU | WTA_MAIN | 23.5 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL11BERDEL | ATP_CHALL | 2.567 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11DIAGAS | ATP_CHALL | 138.1 | 8 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GALFEA | ATP_CHALL | 0.233 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GIUDAM | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11PIRKYM | ATP_CHALL | 21.0 | — | **WAKING** |
...
| ATPMATCH-26JUL11PRAMAJ | ATP_MAIN | 1.367 | — | **WAKING** |
...
| ITFMATCH-26JUL11MCIALF | ITF_M | 44.667 | — | **WAKING** |
| ITFMATCH-26JUL11SAMLOP | ITF_M | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL11BABGER | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL11FULSOU | ITF_W | 3.167 | — | **WAKING** |
| ITFWMATCH-26JUL11GORKOS | ITF_W | 20.5 | — | **WAKING** |
...
| WTAMATCH-26JUL11PANKUL | WTA_MAIN | 0.033 | 1 | **WAKING** |
...
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 275, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 267, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 261, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 199, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 178, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 177, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 151, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFMATCH-26JUL11KELWES-KEL {"kind": "position_basis", "ref": 63.0, "market_mid": 5.5, "divergence": 57.5}
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 135, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 133, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 128, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 122, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 120, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 109, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 97, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 97, "mode": "SET_BELOW_FLOW(prints 2c above)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 91, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 82, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPMATCH-26JUL11PRAMAJ-MAJ {"fill": 15, "age_min": 62, "mode": "NO_BID(sib rested earlier, none now)"}
...
- reality_divergence: KXATPMATCH-26JUL11NEUPOL-POL {"kind": "position_basis", "ref": 30.0, "market_mid": 3.5, "divergence": 26.5, "emitted_et": "2026-07-11 01:27:24 PM ET"}
