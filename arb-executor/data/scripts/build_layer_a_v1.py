...
# Cell-key classification logic moved to cell_key_helpers.py per LESSONS C27 +
# ROADMAP T31b prep (Session 6 Phase 5-v). Both Layer A and Layer B producers
# import from the shared module to prevent drift between aggregation and
# trajectory walk. DO NOT inline these helpers back into this file.
from cell_key_helpers import (ENTRY_BANDS, SPREAD_BANDS, VOLUME_BANDS, REGIMES, CATEGORIES, categorize, entry_band_idx, spread_band_name, detect_match_start, regime_for_moment, volume_intensity_for_market)
