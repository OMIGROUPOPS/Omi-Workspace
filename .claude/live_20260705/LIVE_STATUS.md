...
- cycle 243 @ **2026-07-17 07:38:55 PM ET** | build `cf6f9ab9` | session boot 07-17 15:16 ET | log `live_v3_20260717.jsonl` | 12515 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17FORTOM-F | 31 | 219m | 19/33-35/1688 | 34-35 | 2 | **FLOW_ABOVE** | 31 | flow above but bound 31c < flow -- chasing breaks goal |
| ITFMATCH-26JUL18AGIOVC-AGI | 22 | 36m | 2/23-23/24 | 22-23 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→23 |
...
| ATPCHALLENGERMATCH-26JUL17LAJNOG | 71 | 34 | **105** | 97 | +8 |
...
## FLOW-STATE — 9 tracked game(s) ({'WAKING': 5, 'QUIET': 2, 'OPEN': 2}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL17SMIYUN | ATP_CHALL | 9.867 | 1 | **OPEN** |
| ITFMATCH-26JUL17OCODEL | ITF_M | 1.633 | 2 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL17LAJNOG | ATP_CHALL | 17.767 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL17VUKGAL | ATP_CHALL | 66.9 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL17WONJOH | ATP_CHALL | 25.933 | — | **WAKING** |
| ITFMATCH-26JUL18AGIOVC | ITF_M | 0.067 | 1 | **WAKING** |

## PATTERNS (sub-B) — 18
- half_arm_aging: KXITFMATCH-26JUL17NEFGAI-GAI {"fill": 46, "age_min": 262, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17DELFUE-DEL {"kind": "position_basis", "ref": 86.0, "market_mid": 29.0, "divergence": 57.0}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17HOLBOU-BOU {"fill": 33, "age_min": 248, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17WONJOH-WON {"fill": 64, "age_min": 211, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17SMIYUN-YUN {"fill": 63, "age_min": 186, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17VUKGAL-GAL {"fill": 53, "age_min": 164, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17SANALM-ALM {"kind": "position_basis", "ref": 68.0, "market_mid": 12.5, "divergence": 55.5}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17FORTOM-TOM {"fill": 66, "age_min": 92, "mode": "SET_BELOW_FLOW(prints 2c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL17LAJNOG-LAJ {"fill": 71, "age_min": 33, "mode": "NO_BID(sib rested earlier, none now)", "emitted_et": "2026-07-17 07:38:54 PM ET"}
...
- reality_divergence: KXATPCHALLENGERMATCH-26JUL17WONJOH-WON {"kind": "position_basis", "ref": 64.0, "market_mid": 36.5, "divergence": 27.5, "emitted_et": "2026-07-17 07:38:54 PM ET"}
