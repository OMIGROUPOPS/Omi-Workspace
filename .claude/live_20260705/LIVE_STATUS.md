...
- cycle 13 @ **2026-07-04 11:15:30 PM ET** | build `51f725f` | session boot 07-04 21:32 ET | log `live_v3_20260704.jsonl` | 3489 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFWMATCH-26JUL04BROKOI-BRO | 76 | 101m | 1350/80-99/350336 | 99-78 | 4 | **FLOW_ABOVE** | 76 | flow above but bound 76c < flow -- chasing breaks goal |
| ITFWMATCH-26JUL04MAXSTE-STE | 83 | 103m | 545/86-99/126759 | 99-86 | 3 | **FLOW_ABOVE** | 83 | flow above but bound 83c < flow -- chasing breaks goal |
...
## PATTERNS (sub-B) — 4
- half_arm_aging: KXITFWMATCH-26JUL04MAXSTE-MAX {"fill": 14, "age_min": 103, "mode": "SET_BELOW_FLOW(prints 3c above)"}
- half_arm_aging: KXITFWMATCH-26JUL04BROKOI-KOI {"fill": 21, "age_min": 101, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- deep_neg_fv: KXATPCHALLENGERMATCH-26JUL04LEGWIN-LEG {"entry_minus_fv_burst": -34.0}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL04LEGWIN-LEG {"fill": 80, "age_min": 95, "mode": "PAIRING(sib never rested)"}
