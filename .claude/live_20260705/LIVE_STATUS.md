...
- cycle 66 @ **2026-07-05 10:02:36 PM ET** | build `750cba3` | session boot 07-05 19:24 ET | log `live_v3_20260705.jsonl` | 3964 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL05LEGSHI-L | 43 | 108m | 4441/42-98/402903 | 95-42 | -1 | **FLOW_AT_LEVEL** | 48 |  |
| ATPCHALLENGERMATCH-26JUL05LEGSHI-L | 42 | 103m | 4325/42-98/397341 | 95-42 | 0 | **FLOW_AT_LEVEL** | 48 |  |

## COULD-HAVE-FILLED — open pairs, achievable-combined RIGHT NOW
no open half-pairs

## PATTERNS (sub-B) — 3
- half_arm_aging: KXITFMATCH-26JUL05MASCIO-MAS {"fill": 33, "age_min": 157, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL05VANGAU-GAU {"fill": 7, "age_min": 156, "mode": "NO_BID(sib rested earlier, none now)"}
