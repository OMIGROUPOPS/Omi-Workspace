...
- **C-THE-WALK v1 (standing protocol, armed)** — founding walk DONE (FOMLIM: account/amendment/proof/filing; NEW-CLASS WINDOW-TRUTH BLINDNESS founded, shadow-first, arming gated on the word). **Part 0 DONE: THE DOCKET delivered unprompted (86 D/F legs, net −326¢, post-bell riders + Serafini surfaced by the machine itself; `.claude/walks/20260716/DOCKET.md`). AWAITING THE OPERATOR'S PRIVATE LIST — the diff is the capability score. THEN the first batch — flag games in plain words off today's sheet; the trio returns in review order.**
