...
import { faceDataPlugin,compressedStaticPreview } from "./scripts/face-data-plugin.mjs";
...
export default defineConfig({
  root: at("./demo/"),
  publicDir: at("./.vercel/tune100-public-gzip/"),
  envDir: false,
  envPrefix: [],
  resolve: { alias: { "@": at("./src/") } },
  plugins: [tailwindcss(), react(), faceDataPlugin(),compressedStaticPreview()],
