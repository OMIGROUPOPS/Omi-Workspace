...
- cycle 33 @ **2026-07-10 10:32:46 PM ET** | build `a7b5bc32` | session boot 07-10 17:25 ET | log `live_v3_20260710.jsonl` | 13554 session events | monitor READ-ONLY
...
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL10NAKMAT-MAT | 42 | 1m | 2/46-47/46 | 46-45 | 4 | **FLOW_ABOVE** | 43 | REPRICEABLE→43 |
...
| ITFMATCH-26JUL10DELJAS | ITF_M | 100.333 | — | **WAKING** |
| ITFMATCH-26JUL10NAKMAT | ITF_M | 4.033 | — | **WAKING** |
...
- half_arm_aging: KXITFMATCH-26JUL10POLMIY-POL {"fill": 32, "age_min": 272, "mode": "PAIRING(sib never rested)"}
