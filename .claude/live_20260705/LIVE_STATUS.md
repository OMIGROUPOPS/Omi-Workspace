...
- cycle 380 @ **2026-07-18 07:30:49 PM ET** | build `f0303582` | session boot 07-18 13:59 ET | log `live_v3_20260718.jsonl` | 18136 session events | monitor READ-ONLY

## ⚠ GUN FEED: last new in-play sighting 78 min ago (>30 tripwire; source observed_starts.db)

## ENTRY DOSSIERS (vault-wired: every surface consulted or named — last 4)
- placed:path_aim UL19RADKON-RAD aim=64 | atlas_page:CONS,contention_s:CONS,pair_state:CONS,reach_law:CONS,range_cell_m:GAP,dip_timing:CONS,flow_state:CONS,orientation_:CONS,fv_gap:NO-R,pm_ref:NO-M,cohort:CONS,refuse_margi:CONS,operator_adj:CONS,fill_regime:CONS
...
- classes now: {'NO_FLOW': 2, 'FLOW_ABOVE': 2} | repriceable now: true 1 / false 3 | **cumulative bid_grade lines: 12887 (repriceable true 1739 / false 11148)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL18LAJYUN-L | 33 | 324m | 35/35-37/1507 | 35-36 | 2 | **FLOW_ABOVE** | 34 | REPRICEABLE→34 |
| ITFWMATCH-26JUL18THOAIA-THO | 13 | 11m | 129/19-21/9295 | 19-15 | 6 | **FLOW_ABOVE** | 13 | flow above but bound 13c < flow -- chasing breaks goal |
| ITFWMATCH-26JUL19VANCIR-CIR | 43 | 0m | 0 | 54-56 | — | **NO_FLOW** | 99 |  |
| WTACHALLENGERMATCH-26JUL18TONSPI-T | 31 | 331m | 0 | 31-59 | — | **NO_FLOW** | 99 |  |
...
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL18LAJYUN | ATP_CHALL | 1.933 | 1 | **OPEN** |
...
| ITFWMATCH-26JUL18THOAIA | ITF_W | 11.1 | — | **WAKING** |
| ITFWMATCH-26JUL19VANCIR | ITF_W | 0.1 | 2 | **WAKING** |

## PATTERNS (sub-B) — 3
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL18RODSAN-SAN {"fill": 21, "age_min": 313, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFWMATCH-26JUL18SAIHOS-HOS {"fill": 36, "age_min": 267, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL18LAJYUN-YUN {"fill": 63, "age_min": 115, "mode": "SET_BELOW_FLOW(prints 2c above)"}
