...
- cycle 124 @ **2026-07-16 11:08:43 PM ET** | build `a6cca07a` | session boot 07-16 22:21 ET | log `live_v3_20260716.jsonl` | 3606 session events | monitor READ-ONLY

## ⚠ GUN FEED: last new in-play sighting 235 min ago (>30 tripwire; source observed_starts.db)

## ENTRY DOSSIERS (vault-wired: every surface consulted or named — last 4)
- placed:path_aim UL16ABDVUX-VUX aim=79 | atlas_page:CONS,contention_s:CONS,pair_state:CONS,reach_law:CONS,range_cell_m:GAP,dip_timing:CONS,flow_state:CONS,refuse_margi:CONS,operator_adj:CONS,fill_regime:CONS,honest_clock:CONS,w1_cohort:SHAD,window_phase:CONS,ca
...
- classes now: {'FLOW_ABOVE': 1} | repriceable now: true 0 / false 1 | **cumulative bid_grade lines: 11990 (repriceable true 1581 / false 10409)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ITFMATCH-26JUL16ALHYAZ-YAZ | 18 | 30m | 4/74-85/18 | 55-84 | 56 | **FLOW_ABOVE** | 99 |  |
...
|---|---|---|---|---|
| ITFMATCH-26JUL16ALHYAZ | ITF_M | 0.133 | 29 | **WAKING** |
