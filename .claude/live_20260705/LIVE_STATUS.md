...
- cycle 5 @ **2026-07-11 12:44:42 PM ET** | build `aea08c05` | session boot 07-11 00:38 ET | log `live_v3_20260711.jsonl` | 42393 session events | monitor READ-ONLY
...
- **half_arm_aging**: KXITFWMATCH-26JUL11MAKSHO-SHO {"fill": 50, "age_min": 704, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11LAGRIV-LAG {"fill": 69, "age_min": 702, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11ERCHRU-HRU {"fill": 82, "age_min": 679, "mode": "PAIRING(sib never rested)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SNIMAZ-SNI {"fill": 75, "age_min": 657, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11SHIROB-ROB {"fill": 68, "age_min": 654, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11HUEBUT-BUT {"fill": 51, "age_min": 636, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPMATCH-26JUL11MONHER-MON {"fill": 59, "age_min": 597, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHEYAM-YAM {"fill": 53, "age_min": 561, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11HOSCIR-HOS {"fill": 64, "age_min": 551, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SMILEY-LEY {"fill": 61, "age_min": 549, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KUBRYS-RYS {"fill": 33, "age_min": 541, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11PERWIE-WIE {"fill": 18, "age_min": 531, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11DENSTR-DEN {"fill": 51, "age_min": 521, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VIRDIE-VIR {"fill": 65, "age_min": 519, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11KARSUP-SUP {"fill": 40, "age_min": 517, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11DURBAR-BAR {"fill": 39, "age_min": 492, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11FONROJ-ROJ {"fill": 44, "age_min": 488, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11TALPAP-PAP {"fill": 58, "age_min": 478, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 36.0, "divergence": 26.0}
- **half_arm_aging**: KXATPMATCH-26JUL11DHASAC-DHA {"fill": 35, "age_min": 474, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11MICHEM-HEM {"fill": 49, "age_min": 464, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11RINCHO-RIN {"fill": 32, "age_min": 457, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11STATOM-STA {"kind": "position_basis", "ref": 62.0, "market_mid": 32.0, "divergence": 30.0}
- **half_arm_aging**: KXITFMATCH-26JUL11ROHBOR-ROH {"fill": 53, "age_min": 432, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11ASLSIE-SIE {"fill": 89, "age_min": 430, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11FABARZ-ARZ {"fill": 71, "age_min": 420, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11KARSUP-SUP {"kind": "position_basis", "ref": 40.0, "market_mid": 3.5, "divergence": 36.5}
- **half_arm_aging**: KXATPMATCH-26JUL11CINZAH-CIN {"fill": 87, "age_min": 406, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11BOSKAR-KAR {"fill": 39, "age_min": 406, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11LEEJOR-JOR {"fill": 43, "age_min": 401, "mode": "NO_BID(sib rested earlier, none now)"}
- **reality_divergence**: KXITFWMATCH-26JUL11SHEYAM-YAM {"kind": "position_basis", "ref": 53.0, "market_mid": 24.5, "divergence": 28.5}
- **half_arm_aging**: KXITFMATCH-26JUL11NORKOI-NOR {"fill": 62, "age_min": 394, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11SKACHA-CHA {"fill": 6, "age_min": 375, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFMATCH-26JUL11NICJUA-NIC {"fill": 73, "age_min": 364, "mode": "NO_BID(sib rested earlier, none now)"}
...
- **half_arm_aging**: KXITFWMATCH-26JUL11SHIGAO-GAO {"fill": 61, "age_min": 330, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11HODCHA-HOD {"fill": 91, "age_min": 321, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11NARGUE-NAR {"fill": 57, "age_min": 280, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11SEABAS-BAS {"fill": 22, "age_min": 279, "mode": "QUEUE(flow at/below our level, unfilled)"}
- **half_arm_aging**: KXITFWMATCH-26JUL11SOBAVD-SOB {"fill": 60, "age_min": 272, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11TOPMAR-MAR {"fill": 62, "age_min": 264, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPMATCH-26JUL11VUKOLI-OLI {"fill": 70, "age_min": 263, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11GIUDAM-DAM {"fill": 39, "age_min": 263, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXATPCHALLENGERMATCH-26JUL11BERDEL-BER {"fill": 30, "age_min": 262, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXITFMATCH-26JUL11KELWES-KEL {"fill": 63, "age_min": 261, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 232, "mode": "NO_BID(sib rested earlier, none now)"}
- **half_arm_aging**: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 224, "mode": "NO_BID(sib rested earlier, none now)"}
...
| 11:46 | ITFMATCH-26JUL11BERBEN-BEN | ITF_M | leader | 86 | 83 | +3 (place_cell) | — | pre | pair | 96 | PENDING |
| 11:49 | ATPCHALLENGERMATCH-26JUL11WALMIC-W | ATP_CHALL | underdog | 33 | 30 | +3 (place_cell) | — | pre | single |  | MIXED |
...
| 11:52 | WTAMATCH-26JUL11TANNEP-TAN | WTA_MAIN | underdog | 35 | 33 | +2 (place_cell) | — | pre | pair | 97 | MIXED |
| 11:55 | ITFMATCH-26JUL11ERECRA-CRA | ITF_M | ? | 60 | 56 | +4 (place_cell) | — | pre | single |  | PENDING |
| 12:04 | ITFMATCH-26JUL11YOUKIM-YOU | ITF_M | ? | 48 | 43 | +5 (place_cell) | — | pre | single |  | PENDING |
| 12:05 | WTAMATCH-26JUL11TANNEP-NEP | WTA_MAIN | leader | 62 | 63 | -1 (place_cell) | — | pre | pair | 97 | MIXED |
| 12:09 | ITFMATCH-26JUL11WEIGHA-WEI | ITF_M | leader | 70 | 67 | +3 (place_cell) | — | pre | pair | 97 | PENDING |
| 12:10 | ITFMATCH-26JUL11WEIGHA-GHA | ITF_M | underdog | 27 | 23 | +4 (place_cell) | — | pre | pair | 97 | PENDING |
| 12:15 | ITFMATCH-26JUL11JOHKLA-KLA | ITF_M | underdog | 26 | 21 | +5 (place_cell) | — | pre | single |  | PENDING |
| 12:15 | ITFMATCH-26JUL11BERBEN-BER | ITF_M | underdog | 10 | 9 | +1 (place_cell) | — | pre | pair | 96 | PENDING |
| 12:20 | ITFMATCH-26JUL11BAXLOK-BAX | ITF_M | underdog | 37 | 33 | +4 (place_cell) | — | pre | pair | 97 | PENDING |
| 12:24 | ATPMATCH-26JUL11PRAMAJ-MAJ | ATP_MAIN | underdog | 15 | 13 | +2 (place_cell) | — | pre | single |  | MIXED |
| 12:29 | ATPMATCH-26JUL11NEUPOL-POL | ATP_MAIN | underdog | 30 | 27 | +3 (place_cell) | — | pre | pair | 97 | MIXED |
| 12:31 | ATPMATCH-26JUL11NEUPOL-NEU | ATP_MAIN | leader | 67 | 70 | -3 (place_cell) | — | pre | pair | 97 | MIXED |

## RESTING BIDS — 15 tape-graded (starvation = NO_FLOW only)
- classes now: {'FLOW_AT_LEVEL': 3, 'FLOW_ABOVE': 9, 'NO_FLOW': 3} | repriceable now: true 4 / false 11 | **cumulative bid_grade lines: 8140 (repriceable true 1153 / false 6987)** -- the liquid_repost re-arm evidence accumulates here
| ticker | lvl | age | prints n/rng/sz | book | gap | class | bound(min aim,goal−basis) | note |
|---|---|---|---|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11GALFEA-F | 67 | 54m | 0 | 69-71 | — | **NO_FLOW** | 67 |  |
| ATPCHALLENGERMATCH-26JUL11MEJVAR-M | 64 | 222m | 16/65-66/706 | 64-66 | 1 | **FLOW_ABOVE** | 63 | flow above but bound 63c < flow -- chasing breaks goal |
| ATPCHALLENGERMATCH-26JUL11MEJVAR-V | 34 | 223m | 6/34-35/470 | 34-36 | 0 | **FLOW_AT_LEVEL** | 32 |  |
| ATPCHALLENGERMATCH-26JUL11SEABAS-S | 75 | 279m | 344/72-99/86610 | 98-99 | -3 | **FLOW_AT_LEVEL** | 75 |  |
| ATPCHALLENGERMATCH-26JUL11WALMIC-M | 64 | 55m | 8/68-68/185 | 67-68 | 4 | **FLOW_ABOVE** | 64 | flow above but bound 64c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11JOHKLA-JOH | 71 | 29m | 0 | 74-76 | — | **NO_FLOW** | 71 |  |
| ITFMATCH-26JUL11MIYLEG-LEG | 56 | 80m | 5/59-60/23 | 56-59 | 3 | **FLOW_ABOVE** | 56 | flow above but bound 56c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11SVAZHU-ZHU | 12 | 77m | 147/15-42/16605 | 29-30 | 3 | **FLOW_ABOVE** | 12 | flow above but bound 12c < flow -- chasing breaks goal |
| ITFMATCH-26JUL11VANZAM-VAN | 58 | 134m | 1/59-59/32 | 58-59 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→59 |
| ITFMATCH-26JUL11VANZAM-ZAM | 40 | 98m | 2/41-41/94 | 40-41 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→41 |
| ITFWMATCH-26JUL11MIRMAL-MAL | 12 | 149m | 11/12-13/488 | 12-13 | 0 | **FLOW_AT_LEVEL** | 99 |  |
| ITFWMATCH-26JUL11MIRMAL-MIR | 87 | 116m | 5/88-88/926 | 87-88 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→88 |
| ITFWMATCH-26JUL11SHCCHA-CHA | 19 | 133m | 2/20-20/117 | 19-20 | 1 | **FLOW_ABOVE** | 99 | REPRICEABLE→20 |
| ITFWMATCH-26JUL11SHCCHA-SHC | 80 | 81m | 0 | 80-82 | — | **NO_FLOW** | 99 |  |
| WTAMATCH-26JUL11MORSZI-MOR | 75 | 64m | 2/77-78/24 | 77-78 | 2 | **FLOW_ABOVE** | 75 | flow above but bound 75c < flow -- chasing breaks goal |
...
| ATPMATCH-26JUL11VUKOLI | 70 | 4 | **74** | 97 | -23 |
| ITFMATCH-26JUL11SNIMAZ | 75 | 1 | **76** | 97 | -21 |
| ITFMATCH-26JUL11ROHBOR | 53 | 29 | **82** | 97 | -15 |
| ATPCHALLENGERMATCH-26JUL11PIRKYM | 59 | 26 | **85** | 97 | -12 |
...
| ATPCHALLENGERMATCH-26JUL11BERDEL | 30 | 67 | **97** | 97 | +0 |
...
| ATPMATCH-26JUL11PRAMAJ | 15 | 86 | **101** | 97 | +4 |
| ATPMATCH-26JUL11BRAGOM | 54 | 48 | **102** | 97 | +5 |
| ITFMATCH-26JUL11JOHKLA | 26 | 76 | **102** | 97 | +5 |
| ITFMATCH-26JUL11CIGZAR | 26 | 78 | **104** | 97 | +7 |
| ATPMATCH-26JUL11SKACHA | 6 | 99 | **105** | 97 | +8 |
| WTAMATCH-26JUL11PANKUL | 9 | 98 | **107** | 97 | +10 |
...
| ITFMATCH-26JUL11SVAZHU | 85 | 30 | **115** | 97 | +18 |
...
| WTACHALLENGERMATCH-26JUL11MINVOL | 47 | 81 | **128** | 97 | +31 |
...
| ATPMATCH-26JUL11NARGUE | 57 | 78 | **135** | 97 | +38 |
...
## FLOW-STATE — 86 tracked game(s) ({'OPEN': 25, 'QUIET': 42, 'WAKING': 19}; thresholds PROVISIONAL, refit by the early-canvas study; window 30m)
| game | cat | prints/min | spread | state |
|---|---|---|---|---|
| ATPCHALLENGERMATCH-26JUL11BERDEL | ATP_CHALL | 12.967 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL11DIAGAS | ATP_CHALL | 38.867 | 1 | **OPEN** |
| ATPCHALLENGERMATCH-26JUL11PIRKYM | ATP_CHALL | 16.533 | 1 | **OPEN** |
| ATPMATCH-26JUL11BRAGOM | ATP_MAIN | 1.333 | 1 | **OPEN** |
| ATPMATCH-26JUL11DHASAC | ATP_MAIN | 1.9 | 1 | **OPEN** |
| ATPMATCH-26JUL11NARGUE | ATP_MAIN | 12.967 | 1 | **OPEN** |
| ATPMATCH-26JUL11VUKOLI | ATP_MAIN | 4.9 | 1 | **OPEN** |
| ITFMATCH-26JUL11BAXLOK | ITF_M | 1.567 | 1 | **OPEN** |
| ITFMATCH-26JUL11BERBEN | ITF_M | 7.267 | 1 | **OPEN** |
| ITFMATCH-26JUL11CIGZAR | ITF_M | 1.8 | 1 | **OPEN** |
| ITFMATCH-26JUL11ERECRA | ITF_M | 3.067 | 1 | **OPEN** |
| ITFMATCH-26JUL11FRAMAR | ITF_M | 9.2 | 1 | **OPEN** |
| ITFMATCH-26JUL11MCIALF | ITF_M | 90.733 | 1 | **OPEN** |
| ITFMATCH-26JUL11MIYLEG | ITF_M | 0.4 | 3 | **OPEN** |
| ITFMATCH-26JUL11SVAZHU | ITF_M | 6.033 | 1 | **OPEN** |
| ITFMATCH-26JUL11WEIGHA | ITF_M | 4.733 | 3 | **OPEN** |
| ITFMATCH-26JUL11YOUKIM | ITF_M | 1.867 | 1 | **OPEN** |
| ITFWMATCH-26JUL11FULSOU | ITF_W | 6.533 | 2 | **OPEN** |
| ITFWMATCH-26JUL11GORKOS | ITF_W | 12.667 | 1 | **OPEN** |
| ITFWMATCH-26JUL11HOSDAA | ITF_W | 8.767 | 1 | **OPEN** |
| ITFWMATCH-26JUL11MIRMAL | ITF_W | 0.267 | 1 | **OPEN** |
| WTACHALLENGERMATCH-26JUL11MINVOL | WTA_CHALL | 2.3 | 1 | **OPEN** |
| WTAMATCH-26JUL11PANKUL | WTA_MAIN | 4.333 | 1 | **OPEN** |
| WTAMATCH-26JUL11TANNEP | WTA_MAIN | 6.233 | 1 | **OPEN** |
| WTAMATCH-26JUL11YASGLU | WTA_MAIN | 6.667 | 1 | **OPEN** |
...
| ATPCHALLENGERMATCH-26JUL11GALFEA | ATP_CHALL | 0.033 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11GIUDAM | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11MEJVAR | ATP_CHALL | 0.133 | 2 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11SEABAS | ATP_CHALL | 0.0 | 1 | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11SOTCLA | ATP_CHALL | 4.567 | — | **WAKING** |
| ATPCHALLENGERMATCH-26JUL11WALMIC | ATP_CHALL | 0.267 | 1 | **WAKING** |
| ATPMATCH-26JUL11CECAJD | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ATPMATCH-26JUL11CINZAH | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ATPMATCH-26JUL11NEUPOL | ATP_MAIN | 1.933 | 2 | **WAKING** |
| ATPMATCH-26JUL11PRAMAJ | ATP_MAIN | 0.3 | 2 | **WAKING** |
| ATPMATCH-26JUL11SKACHA | ATP_MAIN | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11JOHKLA | ITF_M | 0.067 | 1 | **WAKING** |
| ITFMATCH-26JUL11SAMLOP | ITF_M | 0.0 | 1 | **WAKING** |
| ITFMATCH-26JUL11VANZAM | ITF_M | 0.067 | 1 | **WAKING** |
| ITFWMATCH-26JUL11BABGER | ITF_W | 0.0 | 1 | **WAKING** |
| ITFWMATCH-26JUL11MARPAR | ITF_W | 0.0 | 4 | **WAKING** |
| ITFWMATCH-26JUL11SHCCHA | ITF_W | 0.033 | 1 | **WAKING** |
| WTAMATCH-26JUL11MICNIN | WTA_MAIN | 0.0 | 1 | **WAKING** |
| WTAMATCH-26JUL11MORSZI | WTA_MAIN | 0.0 | 1 | **WAKING** |
...
- half_arm_aging: KXWTAMATCH-26JUL11TSEMAN-MAN {"fill": 94, "age_min": 232, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MICNIN-NIN {"fill": 16, "age_min": 224, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11PIRKYM-PIR {"fill": 59, "age_min": 218, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFWMATCH-26JUL11HOSDAA-DAA {"fill": 42, "age_min": 157, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXWTAMATCH-26JUL11RENTON-REN {"fill": 12, "age_min": 135, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTACHALLENGERMATCH-26JUL11MINVOL-MIN {"fill": 47, "age_min": 135, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11CIGZAR-CIG {"fill": 26, "age_min": 109, "mode": "NO_BID(sib rested earlier, none now)"}
- reality_divergence: KXITFMATCH-26JUL11KELWES-KEL {"kind": "position_basis", "ref": 63.0, "market_mid": 5.5, "divergence": 57.5}
- half_arm_aging: KXITFWMATCH-26JUL11FULSOU-FUL {"fill": 77, "age_min": 93, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11SOTCLA-CLA {"fill": 35, "age_min": 90, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXATPMATCH-26JUL11BRAGOM-BRA {"fill": 54, "age_min": 85, "mode": "NO_BID(sib rested earlier, none now)"}
...
- half_arm_aging: KXITFMATCH-26JUL11MIYLEG-MIY {"fill": 41, "age_min": 80, "mode": "SET_BELOW_FLOW(prints 3c above)"}
- half_arm_aging: KXITFMATCH-26JUL11SVAZHU-SVA {"fill": 85, "age_min": 77, "mode": "SET_BELOW_FLOW(prints 3c above)"}
- half_arm_aging: KXWTAMATCH-26JUL11PANKUL-PAN {"fill": 9, "age_min": 66, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXWTAMATCH-26JUL11MORSZI-SZI {"fill": 22, "age_min": 64, "mode": "SET_BELOW_FLOW(prints 2c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11WALMIC-WAL {"fill": 33, "age_min": 55, "mode": "SET_BELOW_FLOW(prints 4c above)"}
- half_arm_aging: KXATPCHALLENGERMATCH-26JUL11GALFEA-GAL {"fill": 30, "age_min": 54, "mode": "STARVATION(no prints since post)"}
...
- half_arm_aging: KXITFMATCH-26JUL11ERECRA-CRA {"fill": 60, "age_min": 49, "mode": "NO_BID(sib rested earlier, none now)"}
- half_arm_aging: KXITFMATCH-26JUL11YOUKIM-YOU {"fill": 48, "age_min": 39, "mode": "NO_BID(sib rested earlier, none now)", "emitted_et": "2026-07-11 12:44:42 PM ET"}
...
- reality_divergence: KXATPMATCH-26JUL11NARGUE-NAR {"kind": "position_basis", "ref": 57.0, "market_mid": 17.5, "divergence": 39.5, "emitted_et": "2026-07-11 12:44:42 PM ET"}
- reality_divergence: KXITFWMATCH-26JUL11FULSOU-FUL {"kind": "position_basis", "ref": 77.0, "market_mid": 5.0, "divergence": 72.0, "emitted_et": "2026-07-11 12:44:42 PM ET"}
- reality_divergence: KXITFWMATCH-26JUL11GORKOS-KOS {"kind": "position_basis", "ref": 72.0, "market_mid": 44.5, "divergence": 27.5, "emitted_et": "2026-07-11 12:44:42 PM ET"}
